...
ms.openlocfilehash: 00b8e5b4791c07597e158c3411ceea2a7fb199c3
ms.sourcegitcommit: e184d264c55f0e7e224837ce39ee976ccb4122c2
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/24/2020
ms.locfileid: "95820641"
---
...
[ ![ 下载蓝牙测试平台](images/download.png)](//download.microsoft.com/download/e/e/e/eeed3cd5-bdbd-47db-9b8e-ca9d2df2cd29/BluetoothTestPlatformPack-1.4.3.msi)软件包下载蓝牙测试平台软件包。

## <a name="version-updates"></a>版本更新

| 版本 | 更改 |
|---------|---------|
| 1.4.3     | -添加的 HFP 中断 A2DP 测试。</br>-改进了错误日志。</br>-改进了音频音量和故障检测。</br>-使 Bluefruit 首选连接间隔更快。</br>-对测试可靠性进行了几项修复和改进。</br> |
| 1.4.0     | -添加了对 HID 测试的键盘延迟测试。</br>-向 HID 测试添加了鼠标测试。</br>-添加了音频 + HID 方案测试。</br>-增加了电池测试。</br>-修复了在较旧的 Windows 版本中运行时导致测试无法加载的问题。</br>-修复了在非本机 CMD/PowerShell 环境上运行时失败的脚本。</br>-对测试可靠性进行了几项修复和改进。</br> |
| 1.3.1     | -添加了支持 A2DP 和 HFP 的音频测试。</br>-通过 Traduci 上的 FPGA 添加了音频音量验证和故障检测。</br>-将测试重命名为更短、更多的用户友好名称。</br>-对测试可靠性进行了几项修复和改进。</br> |
| 1.2.1     | -将 BTP 从专用预览移动到公共预览。</br>-添加了 SleepTests 的新功能，其中演示了执行延迟的命令的 Traduci 功能。</br>-对测试可靠性进行了几项修复和改进。</br>|
