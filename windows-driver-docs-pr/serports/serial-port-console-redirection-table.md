...
> 1)  Microsoft 的社区承诺，提供时间<https://www.microsoft.com/openspecifications/en/us/programs/community-promise/default.aspx>：或
> 2)  从2012年10月1日开始的开放 Web 基础最终规范协议版本1.0 （"OWF 1.0"）， http://www.openwebfoundation.org/legal/the-owf-1-0-agreements/owfa-1-0网址为。 
...
| 接口类型 | 1 | 36 | 指示注册接口的类型： <p> 对于修订版本1： </p> <ul><li>0 = 完整16550接口 </li><li>1 = 完整16450接口（还必须接受写入 16550 FCR register） </li><li>2-255 = 保留 </li></ul><p>对于修订版2： </p>请参阅 [DBG2 规范] 的表3中的串行端口子类型（https://docs.microsoft.com/previous-versions/windows/hardware/design/dn639131(v=vs.85)
) </p>| 
| 保留 | 3 | 37 | 必须为 0。 | 
...
|IRQ|1|53 | UART 使用的与计算机兼容的 IRQ。<p>2-7、9-12、14-15 = 分别为有效的 Irq</p><p>0-1、8、13、16-255 = 保留</p><p>仅当设置了中断类型字段的位 [0] 时才有效。</p> | 
...
| Parity|1 | 59 | <p>0 = 无奇偶校验</p><p>1-255 = 保留</p> | 
