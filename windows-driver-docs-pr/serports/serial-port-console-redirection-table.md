...
- UART
ms.date: 07/23/2018
ms.openlocfilehash: cbfaccba2d5c7ed6fa9c3ccbc93959ac91b3764e
ms.sourcegitcommit: ac28dd2a921c25796d19572a180b88e460420488
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/02/2021
ms.locfileid: "101682296"
---
...
| 中断类型 | 1 | 52 | UART 使用的中断类型 () ：<ul><li>位 [0]： PC 兼容双 8259 IRQ 中断</li><li>位 [1]： i/o APIC 中断 (全局系统中断) </li><li>位 [2]： i/o SAPIC 中断 (全局系统中断) </li><li>位 [3]： ARMH GIC 中断 (全局系统中断) </li><li>Bit [4： 7]：保留的 (必须设置为 0) </li></ul> Where <ul><li>0 = 不支持</li><li>1 = 支持</li></ul> 同时具有双8259和 i/o APIC 或 i/o SAPIC 的平台必须将 IRQ 位 (位 [0] ) ，并将相应的全局系统中断位 (例如，支持8259和 SAPIC 的系统将是 5) 。 |
...
| 流控制 | 1 | 61 | <ul><li>Bit [0] = 传输所需的 DCD</li><li>位 [1] = RTS/CTS 硬件流控制</li><li>位 [2] = XON/XOFF 软件控制</li><li>Bit [3： 7] = reserved，必须为零</li></ul> |
