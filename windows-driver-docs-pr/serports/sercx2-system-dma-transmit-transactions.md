...
**SerCx2SystemDmaTransmitCreate**方法创建系统 DMA 传输对象，并提供与调用驱动程序[ **SERCX2SYSTEMDMATRANSMIT** ](https://msdn.microsoft.com/library/windows/hardware/dn265308)这句柄对象。 在驱动程序*EvtSerCx2SystemDmaTransmit*Xxx * * 函数所有采用该句柄作为其第一个参数。 以下 SerCx2 方法将此句柄作为其第一个参数：
