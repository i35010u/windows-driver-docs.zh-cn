...
UPS 微型驱动程序都可以使用 Microsoft Windows 安装程序 （Windows SDK 文档中所述） 或 INF 文件安装的用户模式 Dll (请参阅[创建一个 INF 文件](https://msdn.microsoft.com/library/windows/hardware/ff549520))。
