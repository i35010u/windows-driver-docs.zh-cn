...
类驱动程序接收所有 miniclass 驱动程序的信息和状态，并通过复合电池驱动程序将其报告给电源管理器。 为了响应电池 IOCTLs，类驱动程序调用 miniclass 驱动程序中的[电池 miniclass 驱动程序例程](https://docs.microsoft.com/windows-hardware/drivers/ddi/_battery/)（BatteryMini*Xxx*例程）来执行特定设备控制操作。 此外，应用程序（如电源指示器）可以将[**IRP\_MJ 发送\_设备\_控制**](https://docs.microsoft.com/windows-hardware/drivers/kernel/irp-mj-device-control)请求发送到 miniclass 驱动程序，以获取有关特定电池的信息。
