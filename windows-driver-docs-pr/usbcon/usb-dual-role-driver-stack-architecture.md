...
ms.openlocfilehash: e71cdd57b69c020c81dbf3dcac12b9d87adbfd80
ms.sourcegitcommit: b75e9940d49410e2b952e96f325df67a039cd571
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/21/2020
ms.locfileid: "92337052"
---
# <a name="usb-dual-role-driver-stack-architecture"></a>USB 双角色驱动程序堆栈体系结构

目前 Windows 支持 USB 双重角色控制器，从适用于桌面版的 Windows 10 开始 (Home、Pro、Enterprise 和教育) 和 Windows 10 移动版。

## <a name="introduction"></a>简介

USB 双重角色功能使系统成为 USB *设备* 或 usb *主机*成为可能。 有关 USB 双重角色的详细规范， [请参阅 "中转信息" 页面上的 "](https://www.usb.org/usb-on-the-go) usb-usb"。
...
对于 Windows 10 移动版，不包含收件箱的第三方驱动程序在 WU 上将不可用。 USB 主机堆栈 + HID 的磁盘占用量已经很小。 这就是为什么不是所有类驱动程序，而是 Windows 10 移动版的收件箱中包含的第三方驱动程序的原因。 希望使用第三方驱动程序的 OEM 可以使用 (BSP) 的板支持包，将它们添加到其移动设备的操作系统映像中。

下表显示了 Windows 移动 Sku 上可用的 *函数* 类驱动程序。

> [!NOTE]
> 对于桌面版，函数驱动程序在 Windows 10 上*不可用。*

| USB 函数类驱动程序 | Windows 10 移动版 | Windows 10 桌面版 | 注释 |
| --- | --- | --- | --- |
|  (MTP 响应方的媒体传输协议)  | 是 | 否 | 桌面上没有适用于 MTP 响应程序的方案。 通过 WinUSB 上的 Easy-MigCable 启用了台式系统之间的 P2P 方案。 |
| 视频显示 (vidstream)  | 是 | 否 | |
...
- USB 控制器
    ...
    Chipidea High-Speed USB OTG 控制器。 收件箱 INF： UrsChipidea。
...
## <a name="acpi-system-configuration"></a>ACPI 系统配置
...
## <a name="inf-driver-installation-packages"></a>INF 驱动程序安装包
