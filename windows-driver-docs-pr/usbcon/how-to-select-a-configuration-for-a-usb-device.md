...
1.  获取配置中的接口数。 此信息包含在[**USB \_ 配置 \_ 描述符**](https://docs.microsoft.com/windows-hardware/drivers/ddi/usbspec/ns-usbspec-_usb_configuration_descriptor)结构的**bNumInterfaces**成员中。
