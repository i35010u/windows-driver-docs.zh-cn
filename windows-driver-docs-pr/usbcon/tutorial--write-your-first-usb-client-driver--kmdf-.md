...
有关部署到目标系统中 Visual Studio Professional 2019 驱动程序的详细信息，请参阅[部署到测试计算机的驱动程序](https://msdn.microsoft.com/windows-drivers/develop/deploying_a_driver_to_a_test_computer)。
