...
### <a name="why-windows-requires-the-physical-location-cameras"></a>为什么 Windows 需要的物理位置照相机
...
### <a name="how-to-group-the-camera-into-the-computers-device-container"></a>如何将相机分组到计算机的设备容器
...
### <a name="how-to-provide-physical-location-using-pld-info-in-the-acpi-table"></a>如何提供物理位置使用\_以前 ACPI 表中的信息
...
### <a name="how-to-set-the-model-id-for-the-internal-cameras-device-node"></a>如何设置内部相机的设备节点的模型 ID
...
|必需/可选|必填|
|type|多字符串|
|格式要求|必须包含总线前缀的硬件 id。 所有""字符必须替换为"#"。|
|示例|`USB#VID_1234&PID_ABCD&REV_0001` <br/>`PCI#VEN_ABCD&DEV_1234&SUBSYS_000`|
|备注|可以提供多个硬件 ID 值。 系统时任何硬件 Id 列表中出现多次，设置基于硬件 ID 的设备节点的模型 ID|

### <a name="pldpanel-registry-value"></a>以前\_面板注册表值
...
### <a name="pldpanel-details"></a>以前\_面板的详细信息
