---
title: 定义传感器通用驱动程序常量的自定义值
description: 定义传感器通用驱动程序常量的自定义值
ms.date: 07/20/2018
ms.localizationpriority: medium
ms.openlocfilehash: 37e08227400cb0d1198df0f74cc4de18fda81fd2
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96812353"
---
# <a name="defining-custom-values-for-sensor-constants"></a>定义传感器常量的自定义值
...
如果现有的一组平台定义的常量有效，请避免定义新常量。 研究并了解 [常量](about-sensor-constants.md) 部分中描述的类别、类型、数据字段、属性和事件，并决定传感器驱动程序是否适合平台框架。
