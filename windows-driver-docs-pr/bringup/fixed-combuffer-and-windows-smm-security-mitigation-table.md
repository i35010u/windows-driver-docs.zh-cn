---
title: 固定的 ComBuffer 和 Windows SMM 安全缓解表 (WSMT)
description: 固定的 ComBuffer 和 Windows SMM 安全缓解表 (WSMT)
ms.date: 05/07/2018
...
ms.locfileid: "56527201"
---
# <a name="fixed-combuffer-and-windows-smm-security-mitigation-table-wsmt"></a>固定的 ComBuffer 和 Windows SMM 安全缓解表 (WSMT)
