...
需要确保所有相应的 SMBIOS 字段填充了数据，将 OEM/考虑了 ODM 基于中提供的信息[SMBIOS](smbios.md)指导和以下[DMTF SMBIOS 规范](https://www.dmtf.org/standards/smbios)以确保 CHIDs为单个和唯一。
