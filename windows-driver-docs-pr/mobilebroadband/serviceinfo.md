...
<td><p>引用特定于此 ServiceCategory 的文件的位置。 对于 Windows 8、Windows 8.1 或适用于桌面版的 Windows 10 （家庭版、专业版、企业版和教育版）服务元数据包，这是 MobileBroadbandInfo 的位置。</p></td>
</tr>
</tbody>
</table>
