...
ms.openlocfilehash: 4dbc969b11b0da64a8ede21a3133e394a0a8bf66
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96788501"
---
# <a name="hardwareid-apn-element"></a>HardwareId（APN 元素）


HardwareId 元素为指定的运算符指定 HWID。
...
表示已编码的硬件 ID 的字符串。 生成正确的硬件 ID 值涉及复杂的算法。 建议使用 mbidgenerator.exe 来生成硬件 Id。
