---
title: 处理帐户到达和移除事件的最佳做法
description: 处理帐户到达和移除事件的最佳做法
...
ms.locfileid: "56520135"
---
# <a name="best-practices-for-handling-account-arrival-and-removal-events"></a>处理帐户到达和移除事件的最佳做法
