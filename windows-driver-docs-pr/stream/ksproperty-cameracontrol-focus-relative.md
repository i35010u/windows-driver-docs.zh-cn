...
description: KSPROPERTY\_CAMERACONTROL\_FOCUS\_相对属性指定照相机的焦点设置。
...
ms.locfileid: "72840468"
---
# <a name="ksproperty_cameracontrol_focus_relative"></a>KSPROPERTY\_CAMERACONTROL\_焦点\_相对


KSPROPERTY\_CAMERACONTROL\_FOCUS\_相对属性指定照相机的焦点设置。
...
属性值（操作数据）是指定相机的相对焦点设置的 LONG。 值的大小表示焦点更改的速度;较高的值表示较高的速度。
...
发出集请求时，请在 KSPROPERTY\_CAMERACONTROL\_NODE\_结构的值成员的**值**成员中提供上表中的值之一。

发出 get 请求时，客户端将接收 KSPROPERTY\_CAMERACONTROL\_NODE\_结构的**值**成员的上表中的值之一。 值指示照相机的当前焦点设置。
