---
title: KSEVENT\_调谐器\_已更改
description: KSEVENT\_调谐器\_CHANGED 事件传播操作，例如更改通道，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
ms.assetid: 7286e36c-a433-40a0-9281-7eac4ab64cbf
keywords:
- KSEVENT_TUNER_CHANGED 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.openlocfilehash: 508bf2461b3fc134c95496478ec3e519701f0095
ms.sourcegitcommit: 0cc5051945559a242d941a6f2799d161d8eba2a7
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2019
ms.locfileid: "63368731"
---
# <a name="kseventtunerchanged"></a>KSEVENT\_调谐器\_已更改


KSEVENT\_调谐器\_CHANGED 事件传播操作，例如更改通道，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
