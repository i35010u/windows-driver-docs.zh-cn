...
description: 客户端使用 KSPROPERTY\_BDA\_CA\_模块\_状态来确定与 ECM 映射节点关联的 CA 模块上的状态。
...
ms.locfileid: "72842155"
---
# <a name="ksproperty_bda_ca_module_status"></a>KSPROPERTY\_BDA\_CA\_模块\_状态


客户端使用 KSPROPERTY\_BDA\_CA\_模块\_状态来确定与 ECM 映射节点关联的 CA 模块上的状态。
...
[**KSEVENT\_BDA\_CA\_模块\_状态\_更改**](ksevent-bda-ca-module-status-changed.md)
