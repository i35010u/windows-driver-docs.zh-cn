---
title: KSPROPERTY\_复制\_MACROVISION
description: KSPROPERTY\_复制\_MACROVISION 属性指示的数据流 Macrovision 级别。
ms.assetid: 6863bcf6-06bc-4bd2-896e-43c083aa07d5
keywords:
- KSPROPERTY_COPY_MACROVISION 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "56521777"
---
# <a name="kspropertycopymacrovision"></a>KSPROPERTY\_复制\_MACROVISION


KSPROPERTY\_复制\_MACROVISION 属性指示的数据流 Macrovision 级别。
...
属性值 （操作数据） 是 KS\_复制\_MACROVISION 结构指定的数据流 Macrovision 级别。
