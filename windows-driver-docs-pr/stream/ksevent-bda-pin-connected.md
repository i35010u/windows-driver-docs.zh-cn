---
title: KSEVENT\_BDA\_PIN\_已连接
description: 客户端使用 KSEVENT\_BDA\_PIN\_已连接到将成为连接 pin 时请求通知。
ms.assetid: f17df59d-8904-45a0-bb6b-795b343fd629
keywords:
- KSEVENT_BDA_PIN_CONNECTED 流式处理媒体设备
topic_type:
- apiref
api_name:
...
客户端使用 KSEVENT\_BDA\_PIN\_已连接到将成为连接 pin 时请求通知。
