...
description: 客户端使用 KSPROPERTY\_BDA\_AUTODEMODULATE\_开始自动确定调制解调器节点的参数和解调信号。
ms.assetid: c41a864d-6ed6-4515-bd34-10314e3fdf88
keywords:
- KSPROPERTY_BDA_AUTODEMODULATE_START 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "56523651"
---
# <a name="kspropertybdaautodemodulatestart"></a>KSPROPERTY\_BDA\_AUTODEMODULATE\_START


客户端使用 KSPROPERTY\_BDA\_AUTODEMODULATE\_开始自动确定调制解调器节点的参数和解调信号。
