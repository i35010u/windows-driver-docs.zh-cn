---
title: KSPROPERTY\_批\_平移
description: KSPROPERTY\_批\_平移属性指定批设备的平移设置。
ms.assetid: 5ec4dc6d-44cb-4716-9f5b-dd044cd38239
keywords:
- KSPROPERTY_WAVE_PAN 流式处理媒体设备
topic_type:
- apiref
api_name:
- KSPROPERTY_WAVE_PAN
...
ms.locfileid: "63344988"
---
# <a name="kspropertywavepan"></a>KSPROPERTY\_批\_平移


KSPROPERTY\_批\_平移属性指定批设备的平移设置。
...
属性值 （操作数据） 是 KSWAVE\_平移结构描述左侧和右侧平移级别。
