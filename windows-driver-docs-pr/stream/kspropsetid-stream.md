...
ms.openlocfilehash: e5e602576b32827b2e3e7ff8a04e461e88dbcace
ms.sourcegitcommit: a33b7978e22d5bb9f65ca7056f955319049a2e4c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/31/2019
ms.locfileid: "56519037"
---
# <a name="kspropsetidstream"></a>KSPROPSETID\_Stream


## <span id="ddk_kspropsetid_stream_ks"></span><span id="DDK_KSPROPSETID_STREAM_KS"></span>


客户端使用属性中 KSPROPSETID\_Stream 属性设置为查询其流状态属性的 pin。

KSPROPSETID\_KSPROPERTY 枚举 Stream 属性集\_流并包括：

[**KSPROPERTY\_STREAM\_ALLOCATOR**](ksproperty-stream-allocator.md)

[**KSPROPERTY\_STREAM\_QUALITY**](ksproperty-stream-quality.md)

[**KSPROPERTY\_流\_下降**](ksproperty-stream-degradation.md)
...
[**KSPROPERTY\_流\_PRESENTATIONTIME**](ksproperty-stream-presentationtime.md)
