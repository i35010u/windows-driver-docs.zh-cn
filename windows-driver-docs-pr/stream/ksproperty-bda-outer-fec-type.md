---
title: KSPROPERTY\_BDA\_OUTER\_FEC\_类型
description: 客户端使用 KSPROPERTY\_BDA\_外部\_FEC\_类型来控制某个解调器节点的外部正向纠错（FEC）类型。
...
ms.locfileid: "72837616"
---
# <a name="ksproperty_bda_outer_fec_type"></a>KSPROPERTY\_BDA\_OUTER\_FEC\_类型


客户端使用 KSPROPERTY\_BDA\_外部\_FEC\_类型来控制某个解调器节点的外部正向纠错（FEC）类型。
