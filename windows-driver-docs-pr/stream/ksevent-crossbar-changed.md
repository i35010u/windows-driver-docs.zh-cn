---
title: KSEVENT\_纵横制\_已更改
description: KSEVENT\_纵横制\_CHANGED 事件传播操作，例如新的路由配置，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
ms.assetid: b67d95a3-7c30-49ae-a2df-eb88491c2e97
keywords:
- KSEVENT_CROSSBAR_CHANGED 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.openlocfilehash: 64b3a8bf42ebef81a691218cd9d7003d935fa9a8
...
---
# <a name="kseventcrossbarchanged"></a>KSEVENT\_纵横制\_已更改


KSEVENT\_纵横制\_CHANGED 事件传播操作，例如新的路由配置，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
