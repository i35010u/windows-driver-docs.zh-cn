...
ms.openlocfilehash: 8d015d0e0aa1096e390c650710074c2fbf421fe0
ms.sourcegitcommit: a33b7978e22d5bb9f65ca7056f955319049a2e4c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/31/2019
ms.locfileid: "56542305"
---
# <a name="kspropsetidtsratechange"></a>KSPROPSETID\_TSRateChange


## <span id="ddk_kspropsetid_tsratechange_ks"></span><span id="DDK_KSPROPSETID_TSRATECHANGE_KS"></span>


KSPROPSETID\_TSRateChange 属性设置为控制时间戳速率更改定义属性。 设置此属性可以用于实现快进和后退功能。

KS\_AM\_属性\_TS\_速率\_中的更改枚举*Ksmedia.h*指定此集的属性。

微型驱动程序可以使用 KSPROPSETID\_TSRateChange 任何 MPEG2 流，而不仅仅是 Dvd。
...
[**KS\_AM\_速率\_步骤**](ks-am-rate-step.md)
