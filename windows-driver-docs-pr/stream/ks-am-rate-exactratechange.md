...
description: KS\_AM\_速率\_ExactRateChange 属性尚未实现。
ms.assetid: c96fe88c-04c5-47d9-a9dd-18d06388300e
keywords:
- KS_AM_RATE_ExactRateChange 流式处理媒体设备
topic_type:
- apiref
api_name:
...
KS\_AM\_速率\_ExactRateChange 属性尚未实现。
...
属性值 （操作数据） 是 KS\_AM\_ExactRateChange 结构。
