---
title: KSEVENT\_CAMERACONTROL\_焦点
description: KSEVENT\_CAMERACONTROL\_焦点事件触发时相机焦点操作已完成或已取消。
ms.assetid: 7B10D45F-4673-405C-B44F-3FAA3E8957EF
keywords:
- KSEVENT_CAMERACONTROL_FOCUS 流式处理媒体设备
topic_type:
- apiref
api_name:
...
**KSEVENT\_CAMERACONTROL\_焦点**照相机焦点操作已完成或已被取消时触发事件。
