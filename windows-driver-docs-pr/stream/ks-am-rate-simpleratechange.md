...
description: KS\_AM\_速率\_SimpleDataRate 属性筛选器上设置的时间戳速率。
ms.assetid: 07399986-de5a-42fc-975e-05ea57570f58
keywords:
- KS_AM_RATE_SimpleRateChange 流式处理媒体设备
topic_type:
- apiref
api_name:
...
属性值 （操作数据） 是 KS\_AM\_SimpleRateChange 结构，它描述了 mpeg-2 流、 快进或快退等简单速率更改。
