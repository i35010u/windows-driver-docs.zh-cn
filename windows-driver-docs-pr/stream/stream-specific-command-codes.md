---
title: Stream 特定于命令代码
description: Stream 特定于命令代码
...
ms.locfileid: "56547992"
---
# <a name="stream-specific-command-codes"></a>Stream 特定于命令代码


## <span id="ddk_stream_specific_command_codes_ks"></span><span id="DDK_STREAM_SPECIFIC_COMMAND_CODES_KS"></span>


对于以前打开的流定义特定于 Stream 的命令代码。 **StreamObject** SRB 中的字段指定对其执行指定命令的流。

特定于流的 SRB 命令代码中，与主题中所示的基础结构为：

[**SRB\_关闭\_MASTER\_时钟**](srb-close-master-clock.md)
...
[**SRB\_指示\_MASTER\_时钟**](srb-indicate-master-clock.md)

[**SRB\_开放\_MASTER\_时钟**](srb-open-master-clock.md)
...
[**SRB\_未知\_流\_命令**](srb-unknown-stream-command.md)
