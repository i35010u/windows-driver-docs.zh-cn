...
description: KSEVENT\_CAMERACONTROL\_照相机缩放操作已完成或已被取消时，会触发缩放事件。
ms.assetid: 1580B821-093C-484C-B152-3D4177A8150E
keywords:
- KSEVENT_CAMERACONTROL_ZOOM 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.openlocfilehash: 79defb49537e5f0521a67edf860751e872f20cf3
ms.sourcegitcommit: 0cc5051945559a242d941a6f2799d161d8eba2a7
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2019
ms.locfileid: "63360452"
---
# <a name="kseventcameracontrolzoom"></a>KSEVENT\_CAMERACONTROL\_缩放


**KSEVENT\_CAMERACONTROL\_缩放**照相机缩放操作已完成或已被取消时触发事件。
