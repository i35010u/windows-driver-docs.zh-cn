...
**请注意**  MFT0 应进一步将附加的人脸信息作为 MF\_捕获\_元数据\_FACEROIS，时间戳，MF\_捕获\_元数据\_FACEROITIMESTAMPS，和闪烁和/或笑脸信息作为 MF\_捕获\_元数据\_FACEROICHARACTERIZATIONS 示例。

 

**请注意**  预览、 视频和照片的功能是可选的。 但是，在至少一个预览、 视频和照片功能必须支持此控件支持。
