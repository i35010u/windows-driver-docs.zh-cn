...
description: 客户端使用 KSPROPERTY\_BDA\_SPECTRAL\_反转控制光谱反转解调器节点的设置。
ms.assetid: a51dee0b-4a45-4159-978b-27ff6e2333e2
keywords:
- KSPROPERTY_BDA_SPECTRAL_INVERSION 流式处理媒体设备
topic_type:
- apiref
api_name:
...
SpectralInversion 枚举类型中的返回的值标识光谱反转的设置。
