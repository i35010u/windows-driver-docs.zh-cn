...
description: KSPROPERTY\_调谐器\_NETWORKTYPE\_扫描\_CAPS 属性描述优化设备支持的特定广播的网络类型的扫描功能。 可以根据需要实现此属性。
ms.assetid: 89f66812-9192-4d1d-ac8c-38396fc6be8e
keywords:
- KSPROPERTY_TUNER_NETWORKTYPE_SCAN_CAPS 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "67355982"
---
# <a name="kspropertytunernetworktypescancaps"></a>KSPROPERTY\_TUNER\_NETWORKTYPE\_SCAN\_CAPS


KSPROPERTY\_调谐器\_NETWORKTYPE\_扫描\_CAPS 属性描述优化设备支持的特定广播的网络类型的扫描功能。 可以根据需要实现此属性。
...
属性值 （操作数据） 是 KSPROPERTY\_调谐器\_NETWORKTYPE\_扫描\_CAPS\_S 结构，它指定网络类型的扫描功能。
