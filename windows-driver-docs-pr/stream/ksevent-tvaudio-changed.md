---
title: KSEVENT\_TVAUDIO\_已更改
description: KSEVENT\_TVAUDIO\_CHANGED 事件传播操作，如新调整到的通道支持立体声音频，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
ms.assetid: 98d77001-9844-4893-9a23-9c06f7d75841
keywords:
- KSEVENT_TVAUDIO_CHANGED 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "63324809"
---
# <a name="kseventtvaudiochanged"></a>KSEVENT\_TVAUDIO\_已更改


KSEVENT\_TVAUDIO\_CHANGED 事件传播操作，如新调整到的通道支持立体声音频，从内核模式视频捕获微型驱动程序的对 DirectShow 在用户模式下。
