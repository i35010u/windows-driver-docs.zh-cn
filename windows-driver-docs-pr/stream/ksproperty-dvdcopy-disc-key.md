...
KSPROPERTY \_ DVDCOPY \_ 光盘 \_ 键属性检索 DVD 版权保护身份验证过程的光盘密钥信息。
...
) 操作数据 (的属性值是 \_ \_ 用于描述 DVD 光盘密钥的 KS DVDCOPY DISCKEY 结构。

<a name="remarks"></a>备注
-------

有关光盘密钥的详细信息，请参阅 [DVD 版权保护](./dvd-copyright-protection.md)。
