---
title: 编解码器优点验证
description: 编解码器优点验证
ms.assetid: 595a21ea-bae2-410e-874a-7f3429ac02a1
keywords:
- 硬件编解码器 WDK AVStream，验证价值
- 编解码器 WDK AVStream
- 编解码器 WDK AVStream，荣誉奖验证
- 编解码器 WDK AVStream，硬件
- 编解码器 WDK AVStream，硬件，需要验证
ms.date: 04/20/2017
ms.localizationpriority: medium
ms.openlocfilehash: af4ac82973bd3a997b75de802ed315e6fc2edf5a
ms.sourcegitcommit: a33b7978e22d5bb9f65ca7056f955319049a2e4c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/31/2019
ms.locfileid: "56565434"
---
# <a name="codec-merit-validation"></a>编解码器优点验证


若要支持 KSPROPSETID\_OPMVideoOutput，实现以下方法：

-   KSMETHOD\_OPMVIDEOOUTPUT\_STARTINITIALIZATION

    [IOPMVideoOutput::StartInitialization](https://go.microsoft.com/fwlink/p/?linkid=155056) KSMETHOD 通过驱动程序的代理\_OPMVIDEOOUTPUT\_STARTINITIALIZATION。

-   KSMETHOD\_OPMVIDEOOUTPUT\_ENDINITIALIZATION

    [IOPMVideoOutput::FinishInitialization](https://go.microsoft.com/fwlink/p/?linkid=155053) KSMETHOD 通过驱动程序的代理\_OPMVIDEOOUTPUT\_ENDINITIALIZATION。

-   KSMETHOD\_OPMVIDEOOUTPUT\_GETINFORMATION

    [IOPMVideoOutput::GetInformation](https://go.microsoft.com/fwlink/p/?linkid=155054) KSMETHOD 通过驱动程序的代理\_OPMVIDEOOUTPUT\_GETINFORMATION。

本主题的剩余部分包括这三种方法的实现示例。

若要使用此代码，必须包含以下标头文件<em>:</em>
...
*Testcert.h*是其内容是在本主题底部的示例测试证书。 *Testcert.h*用于测试仅目的并不能用于发布版本; 您必须获取生产驱动程序的证书。

您还必须添加*Ksecdd.lib* TARGETLIBS 一部分向你*源*文件：
