...
description: KSPROPERTY\_MEDIASEEKING\_POSITIONS 属性筛选器设置的媒体时间和/或停止时间。
ms.assetid: 20f0e97a-37bb-4c01-8012-b73bb765f4b9
keywords:
- KSPROPERTY_MEDIASEEKING_POSITIONS 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "67353237"
---
# <a name="kspropertymediaseekingpositions"></a>KSPROPERTY\_MEDIASEEKING\_位置


KSPROPERTY\_MEDIASEEKING\_POSITIONS 属性筛选器设置的媒体时间和/或停止时间。
...
KSPROPERTY\_结构指定当前的位置定位和停止的流的位置相对于总持续时间。
