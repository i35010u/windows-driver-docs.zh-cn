...
description: KSPROPERTY\_MEDIASEEKING\_可用属性检索筛选器当前可用的媒体时间跨度。
ms.assetid: df59f32e-2783-418d-85b9-f9285034c6fa
keywords:
- KSPROPERTY_MEDIASEEKING_AVAILABLE 流式处理媒体设备
topic_type:
- apiref
api_name:
...
ms.locfileid: "63366111"
---
# <a name="kspropertymediaseekingavailable"></a>KSPROPERTY\_MEDIASEEKING\_AVAILABLE


KSPROPERTY\_MEDIASEEKING\_可用属性检索筛选器当前可用的媒体时间跨度。
