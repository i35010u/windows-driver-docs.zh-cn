---
title: 适用于 Windows 10 的新照相机的驱动程序函数
description: 以下的照相机的驱动程序函数是适用于 Windows 10 新功能。
...
ms.locfileid: "56542265"
---
# <a name="new-camera-driver-functions-for-windows-10"></a>适用于 Windows 10 的新照相机的驱动程序函数
