...
description: 本主题将可用的内核模式驱动程序框架（KMDF）驱动程序的功能与可用于用户模式驱动程序框架（UMDF）2驱动程序的功能进行比较。
...
ms.locfileid: "72843650"
---
# <a name="comparing-umdf-2-functionality-to-kmdf"></a>将 UMDF 2 功能与 KMDF 进行比较


本主题将可用的内核模式驱动程序框架（KMDF）驱动程序的功能与可用于用户模式驱动程序框架（UMDF）2驱动程序的功能进行比较。 它旨在帮助您决定是否应该编写 UMDF 2 驱动程序或 KMDF 驱动程序。
...
<tr class="odd">
<td align="left">功能电源状态（UMDF 中提供有限支持）</td>
<td align="left"><a href="supporting-functional-power-states.md" data-raw-source="[Supporting Functional Power States](supporting-functional-power-states.md)">支持功能电源状态</a></td>
</tr>
<tr class="even">
...
有关显示所有 Windows 驱动程序框架（WDF）回调和方法及其框架适用性的表，请参阅[WDF 回调和方法摘要](https://docs.microsoft.com/windows-hardware/drivers/ddi/_wdf/)。
