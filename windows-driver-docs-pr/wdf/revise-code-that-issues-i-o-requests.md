...
<td align="left">类似于与<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iocalldriver" data-raw-source="[&lt;strong&gt;IoCallDriver&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iocalldriver)"><strong>IoCallDriver</strong></a>一起发送的 PIRP 的<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iocancelirp" data-raw-source="[&lt;strong&gt;IoCancelIrp&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iocancelirp)"><strong>IoCancelIrp</strong></a> 。 此框架提供锁，以确保 PIRP 在对<strong>IoCallDriver</strong>和<strong>IoCancelIrp</strong>的调用之间不会完成或释放。</td>
</tr>
<tr class="even">
...
<td align="left">类似于<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ioallocateirp" data-raw-source="[&lt;strong&gt;IoAllocateIrp&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ioallocateirp)"><strong>IoAllocateIrp</strong></a>。 创建一个新的 WDFREQUEST 对象，设置特性，并返回调用方的句柄。</td>
</tr>
<tr class="odd">
...
若要获取异步请求或通过调用[**WdfRequestSend**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfrequest/nf-wdfrequest-wdfrequestsend)发送的任何请求的完成状态，驱动程序将调用[**WdfRequestGetStatus**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfrequest/nf-wdfrequest-wdfrequestgetstatus)。 对于同步请求，它可以立即检索状态。 对于异步请求，驱动程序的 i/o 完成回调通常会检索状态。 有关同步发送请求或异步发送请求的详细信息，请参阅[将 I/o 请求发送到一般 I/o 目标](sending-i-o-requests-to-general-i-o-targets.md)。
