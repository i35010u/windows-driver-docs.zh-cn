---
title: 使用 USB 接口在 UMDF 1.x 驱动程序
description: 使用 USB 接口在 UMDF 1.x 驱动程序
...
ms.locfileid: "56545553"
---
# <a name="working-with-usb-interfaces-in-umdf-1x-drivers"></a>使用 USB 接口在 UMDF 1.x 驱动程序
...
-   [获取接口的信息](https://msdn.microsoft.com/library/windows/hardware/ff561478#obtaining-umdf-usb-interface-information)。

-   [选择一项备用设置 USB 接口](https://msdn.microsoft.com/library/windows/hardware/ff561478#selecting-an-alternate-setting-for-a-umdf-usb-interface)。

### <a name="obtaining-umdf-usb-interface-information"></a>获取 UMDF USB 接口信息

后 UMDF 驱动程序已调用[ **IWDFUsbTargetFactory::CreateUsbTargetDevice** ](https://msdn.microsoft.com/library/windows/hardware/ff560390)方法来创建 UMDF USB 目标设备对象，该驱动程序可以调用[ **IWDFUsbTargetDevice::GetNumInterfaces** ](https://msdn.microsoft.com/library/windows/hardware/ff560366)方法来获取设备支持的 USB 接口的数量。 接下来，驱动程序可以调用[ **IWDFUsbTargetDevice::RetrieveUsbInterface** ](https://msdn.microsoft.com/library/windows/hardware/ff560381)方法来获取指向[IWDFUsbInterface](https://msdn.microsoft.com/library/windows/hardware/ff560312)接口公开USB 设备支持的接口。 然后该驱动程序可以调用每个 USB 接口对象定义的以下方法用于获取有关 USB 接口的信息：
...
检索一个指向[IWDFUsbTargetPipe](https://msdn.microsoft.com/library/windows/hardware/ff560391)公开与指定的 USB 设备接口和管道索引相关联的 framework 管道对象的接口。
...
UMDF 驱动程序可以调用[ **IWDFUsbInterface::SelectSetting** ](https://msdn.microsoft.com/library/windows/hardware/ff560343)方法选择备用设置 USB 之一的接口的设备支持。
