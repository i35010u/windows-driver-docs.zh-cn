...
ms.openlocfilehash: a7f8c1797b397f98d0c6d9ec38119e0194f3b340
ms.sourcegitcommit: e769619bd37e04762c77444e8b4ce9fe86ef09cb
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/31/2020
ms.locfileid: "89188721"
---
# <a name="driver-access-to-hardware"></a>驱动程序对硬件的访问


下表列出了框架设备对象按字母顺序定义的所有事件回调函数。 该表显示了你的驱动程序可在其中访问回调函数的 WDFDEVICE 句柄表示的硬件的回调函数。 你可以访问硬件，因为设备处于工作状态 (D0) 状态。
