...
description: 本主题介绍 User-Mode Driver Framework (UMDF) 驱动程序如何支持内核模式客户端，从 UMDF 版本2开始。
ms.date: 04/20/2017
ms.localizationpriority: medium
ms.openlocfilehash: 77f33809b5f714d4b56b0e0d52effb72b61cff4d
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96836603"
---
# <a name="supporting-kernel-mode-clients-in-umdf-drivers"></a>支持 UMDF 驱动程序中的内核模式客户端


本主题介绍 User-Mode Driver Framework (UMDF) 驱动程序如何支持 *内核模式客户端*，从 UMDF 版本2开始。
