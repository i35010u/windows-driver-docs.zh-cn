...
-   [**WAVEFORMATEXTENSIBLE** ](https://msdn.microsoft.com/library/windows/hardware/ff538802)波形格式 (USBAudio 使用已打包的批\_格式\_24 位数据的 PCM 相反。)
...
[系统提供的 USB 驱动程序](https://msdn.microsoft.com/library/windows/hardware/ff538853)
