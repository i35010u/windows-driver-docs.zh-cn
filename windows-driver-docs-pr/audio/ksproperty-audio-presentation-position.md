---
title: KSPROPERTY\_音频\_演示文稿\_位置
description: KSPROPERTY\_音频\_演示文稿\_属性请求检索结构，它指定要呈现到终结点的音频数据中的当前位置的位置。
...
KSPROPERTY\_音频\_演示文稿\_属性请求检索结构，它指定要呈现到终结点的音频数据中的当前位置的位置。
...
KSPROPERTY\_音频\_演示文稿\_位置属性请求将返回状态\_成功以指示已成功完成。 否则，请求将返回相应的错误状态代码。
