...
在 Windows XP 及更高版本，以及 Microsoft Windows Me，驱动程序播放非 PCM [ **WAVEFORMATEX** ](https://docs.microsoft.com/windows/desktop/api/mmreg/ns-mmreg-twaveformatex)格式应公开其非 PCM 旋转根据以下指导原则。
...
-   微型端口驱动程序的方法**Init**并**NewStream** (有关示例，请参阅[ **IMiniportWavePci::Init** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/portcls/nf-portcls-iminiportwavepci-init)和[ **IMiniportWavePci::NewStream**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/portcls/nf-portcls-iminiportwavepci-newstream)。)

-   微型端口流方法**SetFormat** (有关示例，请参阅[ **IMiniportWavePciStream::SetFormat**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/portcls/nf-portcls-iminiportwavepcistream-setformat)。)
