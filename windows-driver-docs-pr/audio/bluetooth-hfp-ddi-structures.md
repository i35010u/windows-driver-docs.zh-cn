---
title: 蓝牙 HFP DDI 结构
description: 本部分介绍使用 Windows 蓝牙 Handsfree 配置文件 (HFP) 驱动程序的结构。
...
ms.locfileid: "56525753"
---
# <a name="bluetooth-hfp-ddi-structures"></a>蓝牙 HFP DDI 结构


本部分介绍使用 Windows 蓝牙 Handsfree 配置文件 (HFP) 驱动程序的结构。
