...
有关采样率转换的类型信息的[KMixer 系统驱动程序](https://msdn.microsoft.com/library/windows/hardware/ff537039#kmixer-system-driver)执行时，请参阅[KMixer 驱动程序的采样率转换和混合策略](https://msdn.microsoft.com/library/windows/hardware/ff537047)。
