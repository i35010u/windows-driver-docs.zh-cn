...
description: 在 Windows 8.1 及更高版本，主键\_MFX\_ProcessingModes\_支持\_为\_流式处理属性键标识处理为流式处理受支持的模式模式效果驱动程序。
...
ms.locfileid: "63332113"
---
# <a name="pkeymfxprocessingmodessupportedforstreaming"></a>PKEY\_MFX\_ProcessingModes\_Supported\_For\_Streaming


Windows 8.1 及更高版本，**主键\_MFX\_ProcessingModes\_支持\_有关\_流式处理**属性键标识模式影响处理模式支持流式处理驱动程序支持。 驱动程序开发人员应列出支持的流式处理模式处理的模式影响其驱动程序支持。
