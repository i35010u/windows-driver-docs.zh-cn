...
`KSPROPSETID_AudioGfx`属性集用来通知 GFX 筛选器的设备用于呈现和捕获的音频设备的 Id。 以 null 结尾的 Unicode 字符串的窗体中指定 ID 的设备 (请参阅[设备标识字符串](https://msdn.microsoft.com/library/windows/hardware/ff541224))。
