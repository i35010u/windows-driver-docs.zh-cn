...
KSPROPERTY \_ SYSAUDIO \_ 设备 \_ 接口 \_ 名称属性检索包含指定虚拟音频设备即插即用设备接口名称的 Unicode 字符串。
...
) 操作数据 (的属性值是一个指针，指向以 null 结尾的 Unicode 字符字符串，其中包含设备的接口名称。

### <a name="span-idreturn_valuespanspan-idreturn_valuespanspan-idreturn_valuespanreturn-value"></a><span id="Return_Value"></span><span id="return_value"></span><span id="RETURN_VALUE"></span>返回值

KSPROPERTY \_ SYSAUDIO \_ 设备 \_ 接口 \_ 名称属性请求返回状态 " \_ 成功" 以指示它已成功完成。 否则，请求将返回相应的错误状态代码。
