...
-   Pin 应包括在其节点链来表示每个硬件效果要合并到关系图中的单个节点。 由以下 Guid 指定 AEC 和 NS 效果 KS 节点类型：[**KSNODETYPE\_声学\_ECHO\_取消**](https://msdn.microsoft.com/library/windows/hardware/ff537150)
    [**KSNODETYPE\_干扰\_禁止**](https://msdn.microsoft.com/library/windows/hardware/ff537182)
-   支持的插针的 AEC 和 NS 节点应[KSPROPSETID\_常规](https://msdn.microsoft.com/library/windows/hardware/ff566576)属性设置，应提供有关查询时的制造商信息[ **KSPROPERTY\_常规\_COMPONENTID** ](https://msdn.microsoft.com/library/windows/hardware/ff565171)属性。

-   支持的插针的 AEC 和 NS 节点应[KSPROPSETID\_TopologyNode](https://msdn.microsoft.com/library/windows/hardware/ff537491)属性集和其两个属性：

    [**KSPROPERTY\_TOPOLOGYNODE\_启用**](https://msdn.microsoft.com/library/windows/hardware/ff537431)启用影响。

    [**KSPROPERTY\_TOPOLOGYNODE\_重置**](https://msdn.microsoft.com/library/windows/hardware/ff537434)将效果重置为其默认状态。

-   插针的 AEC 和 NS 节点应支持的以下属性[KSPROPSETID\_音频](https://msdn.microsoft.com/library/windows/hardware/ff537440)属性集：[**KSPROPERTY\_音频\_CPU\_资源**](https://msdn.microsoft.com/library/windows/hardware/ff537255)
    [**KSPROPERTY\_音频\_算法\_实例**](https://msdn.microsoft.com/library/windows/hardware/ff537240)
-   Pin 应支持以下属性的 KSPROPSETID\_音频属性集：[**KSPROPERTY\_音频\_位置**](https://msdn.microsoft.com/library/windows/hardware/ff537297)
    [**KSPROPERTY\_音频\_延迟**](https://msdn.microsoft.com/library/windows/hardware/ff537286)
...
-   Pin 必须包含一个 AEC 节点 ([**KSNODETYPE\_声学\_ECHO\_取消**](https://msdn.microsoft.com/library/windows/hardware/ff537150))，必须在已排序的节点链 （请参阅中的正确位置中指定的下图）。
...
-   Pin 必须包含 NS 节点 ([**KSNODETYPE\_干扰\_禁止**](https://msdn.microsoft.com/library/windows/hardware/ff537182))，必须在已排序的节点链 （见下文） 中正确的位置中指定的。
...
适配器驱动程序使用的数组[ **PCCONNECTION\_描述符**](https://msdn.microsoft.com/library/windows/hardware/ff537688)结构，以指定内部筛选器的连接。 每个数组元素描述一个连接，可以是节点到节点、 节点 pin 或 pin 的 pin。 有关详细信息，请参阅[节点和连接](nodes-and-connections.md)。
