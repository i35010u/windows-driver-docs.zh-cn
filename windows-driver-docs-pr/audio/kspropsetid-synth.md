...
有关详细信息，请参阅[ **SYNTHCAPS**](https://msdn.microsoft.com/library/windows/hardware/ff538424)。
...
-   讨论 KSPROPERTY\_合成\_LATENCYCLOCK 属性中的[延迟时钟](https://msdn.microsoft.com/library/windows/hardware/ff537503)。
