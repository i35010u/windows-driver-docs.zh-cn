...
通过管理音频适配器混音器线路中的各种硬件控制（例如，音量级别）来补充拓扑端口驱动程序。
...
在上表中，所有**IPortXxx**接口派生自基接口[IPort](https://docs.microsoft.com/windows-hardware/drivers/ddi/portcls/nn-portcls-iport)，所有**IMiniportXxx**接口派生自[IMiniport](https://docs.microsoft.com/windows-hardware/drivers/ddi/portcls/nn-portcls-iminiport)。
