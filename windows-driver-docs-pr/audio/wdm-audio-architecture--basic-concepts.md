---
title: WDM 音频体系结构的基本概念
description: WDM 音频体系结构的基本概念
...
[音频筛选器、 Pin 和节点](audio-filters--pins--and-nodes.md)

[音频的终结点、 属性和事件](audio-endpoints--properties-and-events.md)

[音频数据格式和数据区域](audio-data-formats-and-data-ranges.md)

[数字权限管理](digital-rights-management.md)
