...
description: KSPROPERTY\_DIRECTSOUND3DBUFFER\_速度属性指定三维声音缓冲区的速度。
...
ms.locfileid: "72832828"
---
# <a name="ksproperty_directsound3dbuffer_velocity"></a>KSPROPERTY\_DIRECTSOUND3DBUFFER\_速度


KSPROPERTY\_DIRECTSOUND3DBUFFER\_速度属性指定三维声音缓冲区的速度。
...
属性值（操作数据）是 DS3DVECTOR 类型的结构，用于指定缓冲区速度。 默认情况下，以每秒一个计量单位表示速度，但是可以通过[**KSPROPERTY\_DIRECTSOUND3DLISTENER\_DISTANCEFACTOR**](ksproperty-directsound3dlistener-distancefactor.md)属性来更改单位。

### <a name="span-idreturn_valuespanspan-idreturn_valuespanspan-idreturn_valuespanreturn-value"></a><span id="Return_Value"></span><span id="return_value"></span><span id="RETURN_VALUE"></span>返回值

KSPROPERTY\_DIRECTSOUND3DBUFFER\_速度属性请求返回状态\_SUCCESS，以指示已成功完成。 否则，请求将返回相应的错误状态代码。
