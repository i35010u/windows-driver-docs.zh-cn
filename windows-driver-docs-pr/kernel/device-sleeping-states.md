...
D1 中的设备可能能够请求唤醒。 若要提供有关此状态是否可以支持唤醒信号的信息，总线驱动程序使用[**设备\_功能**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_device_capabilities)结构，或从 Windows 8 开始， [\_D3COLD\_支持\_接口](https://msdn.microsoft.com/library/windows/hardware/hh967714)驱动程序交互.

通常，使用 D1 的设备会这样做，因为从此状态恢复不需要驱动程序还原设备的完整硬件上下文。 若要最大程度地减少用户的延迟，请将设备从 D1 还原到 D0，这可能会导致延迟最小。 最大程度地减少状态转换延迟比降低功率消耗更重要。

### <a href="" id="d2"></a>设备电源状态 D2
...
<a href="" id="wake-up-capability"></a>*唤醒功能*  
D2 中的设备可能能够请求唤醒。 若要提供有关此状态是否可以支持唤醒信号的信息，总线驱动程序使用[**设备\_功能**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_device_capabilities)结构，或从 Windows 8 开始， [\_D3COLD\_支持\_接口](https://msdn.microsoft.com/library/windows/hardware/hh967714)驱动程序交互.
...
D3cold 是 D3 的子状态，其中设备在物理上连接到总线，但无法检测总线上的设备（即在设备再次打开之前）。 在 D3cold 中，以下一项或两项操作成立：
...
<a href="" id="wake-up-capability"></a>*唤醒功能*  
D3hot 子状态中的设备可能会也可能不能请求唤醒。 若要提供有关此子情况是否可以支持唤醒信号的信息，总线驱动程序将使用[**设备\_功能**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_device_capabilities)结构，或从 Windows 8 开始，即[GUID\_D3COLD\_支持\_接口](https://msdn.microsoft.com/library/windows/hardware/hh967714)驱动程序交互.
...
<a href="" id="wake-up-capability"></a>*唤醒功能*  
在 D3cold 子状态中，设备可能会触发唤醒信号来唤醒睡眠计算机。 此功能在[**设备\_功能**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_device_capabilities)结构中报告，从 Windows 8 开始，由[GUID\_D3COLD\_支持\_接口](https://msdn.microsoft.com/library/windows/hardware/hh967714)驱动程序接口。 [](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nc-wdm-get_idle_wake_info) 在信号唤醒计算机之后，设备驱动程序将启动设备从 D3cold 到 D0 的转换。 有关详细信息，请参阅下面的备注。

从 Windows 8 开始，D3cold 子状态下的设备可能能够触发到处于 S0 系统电源状态的计算机的唤醒信号。 此功能由*GetIdleWakeInfo*例程报告。 **设备\_功能**结构不包含有关此功能的信息。 唤醒信号到达后，设备驱动程序将启动设备从 D3cold 到 D0 的转换。 在这种情况下，计算机在信号到达时处于唤醒状态，并且只有设备需要唤醒。
