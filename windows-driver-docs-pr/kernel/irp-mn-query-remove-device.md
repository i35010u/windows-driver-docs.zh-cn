...
有关处理此 IRP 的详细信息，请参阅 [处理 irp \_ MN \_ 查询 \_ 删除 \_ 设备请求](./handling-an-irp-mn-query-remove-device-request.md)。 有关支持设备删除的一般信息，请参阅 [删除设备](./removing-a-device-in-a-function-driver.md)。
