---
title: 处理能力 IRP 时调用 ExSetTimerResolution
description: 处理能力 IRP 时调用 ExSetTimerResolution
...
ms.locfileid: "56521001"
---
# <a name="calling-exsettimerresolution-while-processing-a-power-irp"></a>处理能力 IRP 时调用 ExSetTimerResolution
