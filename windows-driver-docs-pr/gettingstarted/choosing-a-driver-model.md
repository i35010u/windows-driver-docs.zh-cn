...
有关为文件系统筛选器驱动程序选择模型的帮助，请参阅“文件系统微过滤驱动程序”和[文件系统筛选器驱动程序](https://msdn.microsoft.com/library/windows/hardware/ff540382)。
...
有关为文件系统微过滤驱动程序选择模型的帮助，请参阅[文件系统微过滤驱动程序](https://msdn.microsoft.com/library/windows/hardware/ff540402)。
