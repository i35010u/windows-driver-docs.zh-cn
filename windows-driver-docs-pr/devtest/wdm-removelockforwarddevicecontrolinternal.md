...
description: RemoveLockForwardDeviceControlInternal 规则验证，对 IoAcquireRemoveLock 和 IoReleaseRemoveLock 的调用中使用正确转发到另一台设备使用 IoCallDriver IRP 时。
...
ms.openlocfilehash: e97e345cd5c7babae068394557b70a742ac444df
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67393617"
---
# <a name="removelockforwarddevicecontrolinternal-rule-wdm"></a>RemoveLockForwardDeviceControlInternal 规则 (wdm)


**RemoveLockForwardDeviceControlInternal**规则验证的调用[ **IoAcquireRemoveLock** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioacquireremovelock)并[ **IoReleaseRemoveLock** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioreleaseremovelock)中使用正确转发 IRP 使用时[ **IoCallDriver** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-iocalldriver)到另一台设备。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>RemoveLockForwardDeviceControlInternal</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
