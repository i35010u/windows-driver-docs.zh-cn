...
description: MarkStartDevice 规则指定驱动程序 pends IRP\_MN\_正确启动\_设备 IRP。 此规则仅适用于 FDO 和 FIDO 驱动程序。
...
ms.locfileid: "72839160"
---
# <a name="markstartdevice-rule-wdm"></a>MarkStartDevice 规则（wdm）


**MarkStartDevice**规则指定驱动程序 pends IRP\_MN\_正确启动\_设备 IRP。 此规则仅适用于 FDO 和 FIDO 驱动程序。
