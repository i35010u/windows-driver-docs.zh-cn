...
ms.locfileid: "56524681"
---
# <a name="pagedcodeatpowertrans-rule-wdm"></a>PagedCodeAtPowerTrans 规则 (wdm)


**PagedCodeAtPowerTrans**规则指定一个驱动程序不应调用[ **PAGED\_代码**](https://msdn.microsoft.com/library/windows/hardware/ff558773)时响应系统 IRP\_MJ\_POWER Irp (IRP\_MN\_设置\_电源) 到设备 IRP\_MJ\_POWER Irp (IRP\_MN\_设置\_电源)。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>PagedCodeAtPowerTrans</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
