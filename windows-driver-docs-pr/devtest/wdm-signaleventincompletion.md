...
ms.locfileid: "72839850"
---
# <a name="signaleventincompletion-rule-wdm"></a>SignalEventInCompletion 规则（wdm）


**SignalEventInCompletion**规则指定在处理异步 IRP 时，如果设置了**IRP&gt;的 PendingReturned**标志，则驱动程序需要在完成例程中调用[**KeSetEvent**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-kesetevent) 。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>SignalEventInCompletion</strong>规则。</p>
使用以下步骤来运行代码分析：
<ol>
