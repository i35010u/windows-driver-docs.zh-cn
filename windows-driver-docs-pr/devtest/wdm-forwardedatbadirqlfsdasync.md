...
ms.locfileid: "67393979"
---
# <a name="forwardedatbadirqlfsdasync-rule-wdm"></a>ForwardedAtBadIrqlFsdAsync 规则 (wdm)


**ForwardedAtBadIrqlFsdAsync**规则指定驱动程序调用[ **IoCallDriver** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-iocalldriver)并[ **PoCallDriver**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/nf-ntifs-pocalldriver)在 IRQL&lt;调度\_级别，除非要转发的 IRP 主要函数代码是以下值之一：
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>ForwardedAtBadIrqlFsdAsync</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
