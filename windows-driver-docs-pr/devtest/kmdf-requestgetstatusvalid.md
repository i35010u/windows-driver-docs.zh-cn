...
ms.locfileid: "56534419"
---
# <a name="requestgetstatusvalid-rule-kmdf"></a>RequestGetStatusValid 规则 (kmdf)


**RequestGetStatusValid**规则，规定[ **WdfRequestGetStatus** ](https://msdn.microsoft.com/library/windows/hardware/ff549974)应调用的请求的以下情况之一：

-   当[ **WdfRequestSend** ](https://msdn.microsoft.com/library/windows/hardware/ff550027)返回失败。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>RequestGetStatusValid</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
