...
description: IoAllocateFree 规则指定一个驱动程序应仅在使用 IoAllocateIrp 以前分配的 Irp 上使用 IoFreeIrp。
...
ms.locfileid: "67393975"
---
# <a name="ioallocatefree-rule"></a>IoAllocateFree 规则


**IoAllocateFree**规则指定一个驱动程序应使用[ **IoFreeIrp** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-iofreeirp)只能对以前分配的 Irp [ **IoAllocateIrp**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioallocateirp)。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>IoAllocateFree</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
