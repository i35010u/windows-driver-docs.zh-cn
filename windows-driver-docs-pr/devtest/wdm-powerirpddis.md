...
description: PowerIrpDDIs 规则指定当驱动程序正在处理的系统或设备 IRP\_MJ\_IRP 功能\_MN\_设置\_电源，它不应调用仅可在被动时调用的DDIs\_级别。
...
ms.locfileid: "67393676"
---
# <a name="powerirpddis-rule-wdm"></a>PowerIrpDDIs 规则 (wdm)


**PowerIrpDDIs**规则指定当驱动程序正在处理的系统或设备 IRP\_MJ\_与 IRP POWER\_MN\_设置\_电源，它不应调用 DDIs只能在被动调用\_级别。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>PowerIrpDDIs</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
