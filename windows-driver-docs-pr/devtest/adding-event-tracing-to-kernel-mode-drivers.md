...
将所有**EventWrite \<*event*\> **宏添加到要引发事件的源代码中。 您可以查看 [Eventdrv 示例](https://docs.microsoft.com/samples/microsoft/windows-driver-samples/eventdrv/) ，以了解如何为驱动程序源代码中的事件调用其他两个宏。
