...
ms.openlocfilehash: e4cc81feec7cbb76891c0221fe972747da46629b
ms.sourcegitcommit: 9e5a99dc75dfee3caa9a242adc0ed22ae4df9f29
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/28/2020
ms.locfileid: "89043151"
---
...
* [VM 交换机验证](vm-switch-verification.md)选项监视在[hyper-v 可扩展交换机](https://docs.microsoft.com/windows-hardware/drivers/network/hyper-v-extensible-switch)内运行)  (可扩展交换机扩展的筛选器驱动程序。
...
* 验证应该引发中断请求级别 (IRQL) 值（如 [**KeAcquireInStackQueuedSpinLock**](https://docs.microsoft.com/previous-versions/windows/hardware/drivers/ff551899(v=vs.85))）的操作是否确实降低了 irql 值。
