...
ms.locfileid: "67391424"
---
# <a name="childdeviceinitapi-rule-kmdf"></a>ChildDeviceInitApi 规则 (kmdf)


**ChildDeviceInitApi**规则指定，对于子设备，framework 设备对象初始化方法必须在调用之前驱动程序调用[ **WdfDeviceCreate** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfdevice/nf-wdfdevice-wdfdevicecreate)子设备对象的方法。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>ChildDeviceInitApi</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
