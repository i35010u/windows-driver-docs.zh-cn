...
ms.openlocfilehash: 234929d82c05e0724796007cf00341ebdb9f8194
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67392982"
---
# <a name="outputbufferapi-rule-kmdf"></a>OutputBufferAPI 规则 (kmdf)


**OutputBufferAPI**规则指定中使用的缓冲区检索正确的 DDIs [ *EvtIoWrite* ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfio/nc-wdfio-evt_wdf_io_queue_io_write)回调函数。 内*EvtIoWrite*以下 DDIs 不能调用的缓冲区检索回调函数：
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>OutputBufferAPI</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
