...
ms.locfileid: "56569259"
---
# <a name="pendedcompletedrequest3-rule-wdm"></a>PendedCompletedRequest3 规则 (wdm)


**PendedCompletedRequest3**规则指定应通过调用完成挂起的 IRP [ **IoCompleteRequest**](https://msdn.microsoft.com/library/windows/hardware/ff548343)。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>PendedCompletedRequest3</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
