---
title: '\_OID\_函数规则（ndis）的 Irql'
description: Irql\_OID\_函数规则指定必须在正确的 IRQL 级别调用 NDIS OID 请求 DDIs。
...
ms.locfileid: "72840105"
---
# <a name="irql_oid_function-rule-ndis"></a>\_OID\_函数规则（ndis）的 Irql


**Irql\_OID\_函数**规则指定必须在正确的 irql 级别调用 NDIS OID 请求 DDIs。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>Irql_OID_Function</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
