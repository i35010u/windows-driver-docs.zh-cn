...
ms.locfileid: "72839226"
---
# <a name="ioallocateirpsignaleventincompletion3-rule-wdm"></a>IoAllocateIrpSignalEventInCompletion3 规则（wdm）


**IoAllocateIrpSignalEventInCompletion3**规则指定在设置了**Irp&gt;PendingReturned**标志并且完成例程正在处理本地创建的时，需要在完成例程中调用[**KeSetEvent**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-kesetevent)异步 IRP。
