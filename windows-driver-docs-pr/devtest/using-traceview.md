...
ms.locfileid: "56554652"
---
# <a name="using-traceview"></a>使用 TraceView


本部分介绍如何使用 TraceView 的功能。 其中包括：

[TraceView 基础知识](traceview-basics.md)

[创建跟踪会话](creating-a-trace-session.md)

[显示跟踪日志](displaying-a-trace-log.md)

[更改跟踪会话的属性](changing-the-properties-of-a-trace-session.md)
...
[使用 TraceView 窗口](using-the-traceview-window.md)
