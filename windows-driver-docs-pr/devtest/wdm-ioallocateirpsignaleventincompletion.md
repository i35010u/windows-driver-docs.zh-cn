...
ms.locfileid: "56566651"
---
# <a name="ioallocateirpsignaleventincompletion-rule"></a>IoAllocateIrpSignalEventInCompletion 规则


**IoAllocateIrpSignalEventInCompletion**规则指定驱动程序应调用[ **KeSetEvent** ](https://msdn.microsoft.com/library/windows/hardware/ff553253)中完成例程时**Irp-&gt;PendingReturned**设置标志，并开始处理本地创建异步 IRP 完成例程。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>IoAllocateIrpSignalEventInCompletion</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
