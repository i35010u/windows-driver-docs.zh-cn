---
title: KmdfIrql 规则 (kmdf)
description: KmdfIrql 规则指定一个驱动程序小于或等于最大的 IRQL 对该方法的 IRQL 在调用框架方法。
...
ms.openlocfilehash: 9ee9c361422c973ca6676cd847b4a3f935fbb57a
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67393789"
---
# <a name="kmdfirql-rule-kmdf"></a>KmdfIrql 规则 (kmdf)


**KmdfIrql**规则指定一个驱动程序是小于或等于最大的 IRQL 对该方法的 IRQL 在调用框架方法。

此规则是类似于[ **KmdfIrql2** ](kmdf-kmdfirql2.md)规则; 但是， **KmdfIrql2**规则对其具有依赖于其相关的 IRQL 要求回调函数对象的执行级别规范。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>KmdfIrql</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
