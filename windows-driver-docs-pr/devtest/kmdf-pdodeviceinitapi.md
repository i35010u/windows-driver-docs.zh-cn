...
description: PdoDeviceInitAPI 规则指定该 WdfPdoInitAllocate 和所有其他设备对象初始化设置 WDFDEVICE DDIs\_INIT 结构物理设备对象 (PDO) 必须在调用之前，驱动程序调用的 WdfDeviceCreatePDO。
...
ms.locfileid: "67392961"
---
# <a name="pdodeviceinitapi-rule-kmdf"></a>PdoDeviceInitAPI 规则 (kmdf)


**PdoDeviceInitAPI**规则指定[ **WdfPdoInitAllocate** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfpdo/nf-wdfpdo-wdfpdoinitallocate)和所有其他设备对象初始化设置 DDIs [ **WDFDEVICE\_INIT** ](https://docs.microsoft.com/windows-hardware/drivers/wdf/wdfdevice_init)结构的物理设备对象 (PDO) 必须在调用之前驱动程序调用[ **WdfDeviceCreate** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfdevice/nf-wdfdevice-wdfdevicecreate)对 PDO。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>PdoDeviceInitAPI</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
