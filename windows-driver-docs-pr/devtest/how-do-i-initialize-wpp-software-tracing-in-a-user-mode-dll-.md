...
ms.locfileid: "56540385"
---
# <a name="how-do-i-initialize-wpp-software-tracing-in-a-user-mode-dll"></a>如何初始化 WPP 软件跟踪在用户模式 DLL 中？
...
-   如果您的 DLL 用 C 编写的将添加**\#定义**语句**WPP\_OLDCC**到你的源代码。 将之前定义放**\#包括**语句[跟踪消息标头 (.tmh) 文件](trace-message-header-file.md)。 **WPP\_OLDCC**定义为仅为 C 代码。 不需要 c + +。
