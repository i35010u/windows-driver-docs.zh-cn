...
ms.locfileid: "56576223"
---
# <a name="pendedcompletedrequest-rule-wdm"></a>PendedCompletedRequest 规则 (wdm)


**PendedCompletedRequest**规则指定驱动程序的调度例程不返回状态\_IRP 如果驱动程序已调用上的 PENDING [ **IoCompleteRequest**](https://msdn.microsoft.com/library/windows/hardware/ff548343)上传入的 IRP。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>PendedCompletedRequest</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
