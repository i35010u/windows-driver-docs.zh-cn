...
ms.locfileid: "63353874"
---
# <a name="ndisfderegisterfilterdriver-rule-ndis"></a>NdisFDeregisterFilterDriver 规则 (ndis)


筛选器驱动程序必须调用[ **NdisFDeregisterFilterDriver** ](https://msdn.microsoft.com/library/windows/hardware/ff561800)从其[ **FilterDriverUnload** ](https://msdn.microsoft.com/library/windows/hardware/ff549936)例程。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>NdisFDeregisterFilterDriver</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
