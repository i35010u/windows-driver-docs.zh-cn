...
ms.openlocfilehash: ce6189f959048421dfe1199bb7fb45d9bcfcc4e7
ms.sourcegitcommit: 9b3dec2f2cd9a7ed9b340b4794ce6ff4134d8ebe
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/07/2020
ms.locfileid: "91787632"
---
...
|4.1.2|Nothing|激发 SimpleEvent。|在客户端接收到事件。|
...
|4.2.2|Nothing|激发 SimpleEvent。|客户端接收到事件。|
...
|4.2.4|Nothing|激发 SimpleEvent。|客户端接收到事件。|
...
|4.3.3|Nothing|激发 SimpleEvent。|客户端接收到事件。|
|4.3.4|Nothing|激发 IntegerEvent。|在客户端接收事件，并显示正确的整数。|
...
|4.3.7|Nothing|激发 SimpleEvent。|不会在客户端收到事件。|
|4.3.8|Nothing|激发 IntegerEvent。|在客户端接收事件，并显示正确的整数。|
|4.3.9|将取消订阅发送到 IntegerEvent 的 TestDevice。|发送 UnsubscribeResponse。|客户端接收响应，可以前往步骤4.3.10。|
|4.3.10|Nothing|激发 IntegerEvent。|不会在客户端收到事件。|
|**4.4**|**订阅失败和故障**| | |
