...
description: KmdfIrql2 规则指定驱动程序以小于或等于该方法的最大 IRQL 的 IRQL 调用框架方法。
...
ms.openlocfilehash: 139a3f7b042b7fe755275875800153df2853cc9b
ms.sourcegitcommit: 4b7a6ac7c68e6ad6f27da5d1dc4deabd5d34b748
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/24/2019
ms.locfileid: "72839484"
---
# <a name="kmdfirql2-rule-kmdf"></a>KmdfIrql2 规则（kmdf）


**KmdfIrql2**规则指定驱动程序以小于或等于该方法的最大 IRQL 的 irql 调用框架方法。

此规则类似于[**KmdfIrql**](kmdf-kmdfirql.md)规则;但是， **KmdfIrql**规则是在具有 IRQL 要求的回调函数上执行的，而与它们的相关对象的执行级别规范无关。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>KmdfIrql2</strong>规则。</p>
使用以下步骤来运行代码分析：
<ol>
