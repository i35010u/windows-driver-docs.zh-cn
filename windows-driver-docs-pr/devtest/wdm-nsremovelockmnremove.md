...
description: NsRemoveLockMnRemove 规则验证驱动程序是否未返回状态\_\_在处理 IRP\_MJ\_PNP 与 MinorFunction IRP\_MN\_删除\_设备时，不会返回状态。 此规则仅适用于 FDO 和 FIDO 驱动程序。
...
ms.openlocfilehash: 740fd7983226cb5d96ed734198d11402ccc9b37a
ms.sourcegitcommit: 4b7a6ac7c68e6ad6f27da5d1dc4deabd5d34b748
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/24/2019
ms.locfileid: "72839158"
---
# <a name="nsremovelockmnremove-rule-wdm"></a>NsRemoveLockMnRemove 规则（wdm）


**NsRemoveLockMnRemove**规则验证驱动程序是否未返回状态\_\_在处理 IRP\_MJ\_PNP 与 MinorFunction IRP\_MN\_删除\_设备时，不会返回状态。 此规则仅适用于 FDO 和 FIDO 驱动程序。
