...
ms.locfileid: "85916379"
---
# <a name="irqlmmdispatch-rule-wdm"></a>IrqlMmDispatch 规则（wdm）


**IrqlMmDispatch**规则指定仅当驱动程序在**IRQL &lt; = 调度 \_ 级别**执行时才调用[**MmFreeContiguousMemory**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-mmfreecontiguousmemory) 。
