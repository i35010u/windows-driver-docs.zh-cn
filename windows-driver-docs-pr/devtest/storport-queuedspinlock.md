...
ms.locfileid: "72840034"
---
# <a name="queuedspinlock-rule-storport"></a>QueuedSpinLock 规则（storport）


**QueuedSpinLock**规则验证如何使用[**KeReleaseInStackQueuedSpinLock**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-kereleaseinstackqueuedspinlock)立即释放使用[**KeAcquireInStackQueuedSpinLock**](https://docs.microsoft.com/previous-versions/windows/hardware/drivers/ff551899(v=vs.85))获取的堆栈内排队自旋锁。 此外，在调度或取消例程结束时，驱动程序不应持有任何锁。
