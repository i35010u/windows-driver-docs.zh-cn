...
ms.locfileid: "56522191"
---
# <a name="queuedspinlock-rule-storport"></a>QueuedSpinLock 规则 (storport)


**QueuedSpinLock**规则将验证该堆栈中的-排入队列使用获取的自旋锁[ **KeAcquireInStackQueuedSpinLock** ](https://msdn.microsoft.com/library/windows/hardware/ff551899)使用立即发布[**KeReleaseInStackQueuedSpinLock**](https://msdn.microsoft.com/library/windows/hardware/ff553130)。 此外，在调度或取消例程结束时，该驱动程序应该不占用任何锁。
