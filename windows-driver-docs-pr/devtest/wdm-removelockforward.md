...
description: RemoveLockForward 规则验证正确使用对 IoAcquireRemoveLock 和 IoReleaseRemoveLock 调用转发到另一个设备 IRP 时。
...
ms.locfileid: "67393643"
---
# <a name="removelockforward-rule-wdm"></a>RemoveLockForward 规则 (wdm)


**RemoveLockForward**规则验证的调用[ **IoAcquireRemoveLock** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioacquireremovelock)并[ **IoReleaseRemoveLock**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioreleaseremovelock)转发到另一个设备 IRP 时正确使用。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>RemoveLockForward</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
