...
ms.openlocfilehash: 99b3ba123866ddf607e0311921f2c2e06a681964
ms.sourcegitcommit: 0e165d26ea3887d87eb41d591b8d847038a73085
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/05/2021
ms.locfileid: "106381862"
---
...
| [cpp/使用-免费](./codeql-windows-driver-useafterfree.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/可能的 Bug/内存管理/UseAfterFree \ UseAfterFree q* | 空值 |
| [cpp/windows/wdk/弃用的 api](./codeql-windows-driver-wdkdeprecatedapi.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/Windows/wdk/wdk-q* | 空值 |
| [可能的 Bug/边界冲突/PaddingByteInformationDisclosure. q](./codeql-windows-driver-padding-byte-information-disclosure.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/可能的 Bug/边界违规/PaddingByteInformationDisclosure q* | 空值 |
| [可能的 Bug/转换/BadOverflowGuard. q](./codeql-windows-driver-badoverflowguard.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/可能的 Bug/转换/BadOverflowGuard. q* | 空值 |
| [可能的 Bug/转换/InfiniteLoop. q](./codeql-windows-driver-infiniteloop.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/可能的 Bug/转换/InfiniteLoop. q* | 空值 |
| [可能的 Bug/UninitializedPtrField. q](./codeql-windows-driver-uninitializedptrfield.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/可能的 Bug/UninitializedPtrField。 q* | 空值 |
| [cpp/Security/HardcodedIVCNG/q](./codeql-windows-driver-hardcodedivcng.md)   | *Windows 驱动程序-开发人员补充-工具/codeql/windows-驱动程序/查询/安全性/Crytpography/HardcodedIVCNG. q* | 空值 |
...
1. Windows 的安全性非常重要。  需要在驱动程序源代码上运行 CodeQL，这是帮助提高由 Microsoft 进行认证的组件的安全性的一步。
...
不需要，DVL 生成必须在项目级别运行，并且不能在 [Visual Studio 解决方案](/visualstudio/get-started/tutorial-projects-solutions#:~:text=A%20solution%20is%20simply%20a,projects%20that%20the%20solution%20contains.)中运行。  有关如何生成 DVL 的说明，请参阅 [创建驱动程序验证日志](https://docs.microsoft.com/windows-hardware/drivers/develop/creating-a-driver-verification-log)。
...
Microsoft 作为 Windows 驱动程序工具包的一部分随附 (WDK) 和企业版 WDK (eWDK) 名为 *dvl.exe* 的组件，该组件可用于生成 (DVLs) 的驱动程序验证日志。  从 WDK/eWDK preview 版本21342及更高版本开始，可以通过传递驱动程序名称和体系结构，从 msbuild 或 Visual Studio 上下文之外的命令行生成 DVL。  有关更多详细信息，请参阅 [创建驱动程序验证日志](https://docs.microsoft.com/windows-hardware/drivers/develop/creating-a-driver-verification-log) 。
