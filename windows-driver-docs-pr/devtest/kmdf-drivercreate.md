---
title: DriverCreate 规则 (kmdf)
description: DriverCreate 规则指定使用内核模式驱动程序框架 (KMDF) 的驱动程序必须调用 WdfDriverCreate 方法来创建框架的驱动程序对象从其 DriverEntry 例程中。
ms.assetid: a994fd72-4fb2-486b-9d5e-80dedd940c85
ms.date: 05/21/2018
keywords:
- DriverCreate 规则 (kmdf)
topic_type:
- apiref
api_name:
- DriverCreate
...
ms.openlocfilehash: d791a242dc37c8fa9111951263823f4ede494d37
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67393319"
---
# <a name="drivercreate-rule-kmdf"></a>DriverCreate 规则 (kmdf)


**DriverCreate**规则指定使用内核模式驱动程序框架 (KMDF) 的驱动程序必须调用[ **WdfDriverCreate** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfdriver/nf-wdfdriver-wdfdrivercreate)方法来创建框架驱动程序中的对象及其[ **DriverEntry** ](https://docs.microsoft.com/windows-hardware/drivers/wdf/driverentry-for-kmdf-drivers)例程。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>DriverCreate</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
