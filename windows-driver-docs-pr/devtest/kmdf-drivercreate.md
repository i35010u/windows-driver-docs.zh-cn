...
description: DriverCreate 规则指定使用内核模式驱动程序框架（KMDF）的驱动程序必须调用 WdfDriverCreate 方法，以便在其 DriverEntry 例程中创建框架驱动程序对象。
...
ms.openlocfilehash: 55a4232fecc064c68471aba88876707e56bf4ba6
ms.sourcegitcommit: 4b7a6ac7c68e6ad6f27da5d1dc4deabd5d34b748
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/24/2019
ms.locfileid: "72839507"
---
# <a name="drivercreate-rule-kmdf"></a>DriverCreate 规则（kmdf）


**DriverCreate**规则指定使用内核模式驱动程序框架（KMDF）的驱动程序必须调用[**WdfDriverCreate**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfdriver/nf-wdfdriver-wdfdrivercreate)方法，以便在其[**DriverEntry**](https://docs.microsoft.com/windows-hardware/drivers/wdf/driverentry-for-kmdf-drivers)例程中创建框架驱动程序对象。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>DriverCreate</strong>规则。</p>
使用以下步骤来运行代码分析：
<ol>
