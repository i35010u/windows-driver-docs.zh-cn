...
ms.locfileid: "63353403"
---
# <a name="removelockforwardread-rule-wdm"></a>RemoveLockForwardRead 规则 (wdm)


**RemoveLockForwardRead**规则验证的调用[ **IoAcquireRemoveLock** ](https://msdn.microsoft.com/library/windows/hardware/ff548204)并[ **IoReleaseRemoveLock**](https://msdn.microsoft.com/library/windows/hardware/ff549560)中正确使用。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>RemoveLockForwardRead</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
