...
ms.locfileid: "67394067"
---
# <a name="startdevicewait3-rule-wdm"></a>StartDeviceWait3 规则 (wdm)


**StartDeviceWait3**规则指定驱动程序不应调用[ **KeWaitForSingleObject** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-kewaitforsingleobject)开始设备 IRP 的上下文中。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>StartDeviceWait3</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
