...
description: MarkIrpPending2 规则指定如果派单例程返回状态\_"挂起"，则它将调用也或将 IRP 传递到较低的驱动程序。 有关免费规范，请参阅 MarkIrpPending。
...
ms.locfileid: "72839162"
---
# <a name="markirppending2-rule-wdm"></a>MarkIrpPending2 规则（wdm）


**MarkIrpPending2**规则指定如果派单例程返回状态\_"挂起"，则它将调用[**也**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iomarkirppending)或将 IRP 传递到较低的驱动程序。 有关免费规范，请参阅[**MarkIrpPending**](wdm-markirppending.md) 。
