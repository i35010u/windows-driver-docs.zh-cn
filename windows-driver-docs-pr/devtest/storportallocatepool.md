...
ms.openlocfilehash: 344018c4bfc01a0dcc7053138ad8c0fe319fd03a
ms.sourcegitcommit: faff37814159ad224080205ad314cabf412e269f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/02/2020
ms.locfileid: "89384511"
---
# <a name="storportallocatepool-rule-storport"></a>StorPortAllocatePool 规则 (storport) 


此规则验证微型端口是否不能尝试对已释放的缓冲区调用 [**StorPortFreePool**](/windows-hardware/drivers/ddi/storport/nf-storport-storportfreepool) 。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](./static-driver-verifier.md)">静态驱动程序验证程序</a> 并指定 <strong>StorPortAllocatePool</strong> 规则。</p>
使用以下步骤来运行代码分析：
<ol>
