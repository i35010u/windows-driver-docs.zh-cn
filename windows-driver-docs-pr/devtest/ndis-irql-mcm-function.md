...
description: Irql\_MCM\_函数规则指定必须在正确的 IRQL 级别调用用于驱动程序的 NDIS MCM 函数。
...
ms.locfileid: "72839394"
---
# <a name="irql_mcm_function-rule-ndis"></a>Irql\_MCM\_函数规则（ndis）


**Irql\_MCM\_函数**规则指定必须在正确的 Irql 级别调用用于驱动程序的 NDIS MCM 函数。
