...
description: IoReleaseRemoveLockAndWaitOutsideRemoveDevice 规则指定不应使用 IRP\_PNP PNP\_外调用 IoReleaseRemoveLockAndWait，并使用 IRP\_MN\_删除 PnP 驱动程序的\_设备。
...
ms.openlocfilehash: 67f8cee5228ee44d62455c79ce98690b105b42a8
ms.sourcegitcommit: 4b7a6ac7c68e6ad6f27da5d1dc4deabd5d34b748
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/24/2019
ms.locfileid: "72839208"
---
# <a name="ioreleaseremovelockandwaitoutsideremovedevice-rule-wdm"></a>IoReleaseRemoveLockAndWaitOutsideRemoveDevice 规则（wdm）


**IoReleaseRemoveLockAndWaitOutsideRemoveDevice**规则指定不应使用 IRP\_PNP PNP\_外调用[**IoReleaseRemoveLockAndWait**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ioreleaseremovelockandwait) ，并使用 IRP\_MN\_删除 PNP 驱动程序的\_设备。
