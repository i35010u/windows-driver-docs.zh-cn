...
ms.openlocfilehash: d790f3a2d5546ddb9c3360599ea73aca32be805a
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67392002"
---
# <a name="signaleventincompletion3-rule-wdm"></a>SignalEventInCompletion3 规则 (wdm)


**SignalEventInCompletion3**规则指定在处理异步 IRP，该驱动程序必须调用[ **KeSetEvent** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-kesetevent)中完成例程时**Irp-&gt;PendingReturned**设置标志。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>SignalEventInCompletion3</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
