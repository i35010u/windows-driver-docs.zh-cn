...
ms.locfileid: "56521632"
---
# <a name="pnpsamedeviceobject-rule-wdm"></a>PnpSameDeviceObject 规则 (wdm)


**PnpSameDeviceObject**规则指定驱动程序调用[ **IoAttachDeviceToDeviceStack** ](https://msdn.microsoft.com/library/windows/hardware/ff548300)用一个指针指向有效的目标设备对象。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>PnpSameDeviceObject</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
