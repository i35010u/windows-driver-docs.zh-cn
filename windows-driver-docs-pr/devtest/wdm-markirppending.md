...
ms.locfileid: "85917873"
---
# <a name="markirppending-rule-wdm"></a>MarkIrpPending 规则（wdm）


**MarkIrpPending**规则指定每当驱动程序调度例程调用[**也**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iomarkirppending)时，驱动程序在 \_ 调度例程结束时返回状态 "挂起"。 有关免费规范，请参阅[**MarkIrpPending2**](wdm-markirppending2.md) 。
