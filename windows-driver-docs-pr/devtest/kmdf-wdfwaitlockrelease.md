...
ms.locfileid: "67392787"
---
# <a name="wdfwaitlockrelease-rule-kmdf"></a>WdfWaitlockRelease 规则 (kmdf)


**WdfWaitlockRelease**规则指定的调用[ **WdfWaitLockAcquire** ](https://msdn.microsoft.com/library/windows/hardware/ff551168)并[ **WdfWaitLockRelease**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfsync/nf-wdfsync-wdfwaitlockrelease) KMDF 事件回调函数中以平衡方式使用。 KMDF 事件回调函数返回时，该驱动程序不应阻止通过以前调用获得的 framework 自旋锁对象**WdfWaitLockAcquire**。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>WdfWaitlockRelease</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
