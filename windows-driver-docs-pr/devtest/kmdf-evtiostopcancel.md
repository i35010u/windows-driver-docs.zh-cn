...
ms.openlocfilehash: e82713b8454b5470574260e6ab11b1ab68fc72e1
ms.sourcegitcommit: f663c383886d87ea762e419963ff427500cc5042
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67393315"
---
# <a name="evtiostopcancel-rule-kmdf"></a>EvtIoStopCancel 规则 (kmdf)


**EvtIoStopCancel**规则指定内[ *EvtIoStop* ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfio/nc-wdfio-evt_wdf_io_queue_io_stop)回调函数，该驱动程序调用以下方法之一的 I/O 请求的不是可取消。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>EvtIoStopCancel</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
