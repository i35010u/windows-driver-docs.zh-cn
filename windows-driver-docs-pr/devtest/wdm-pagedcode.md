...
description: PagedCode 规则指定驱动程序调用 PAGED\_代码宏仅在执行在 IRQL APC\_级别。
...
ms.locfileid: "56576224"
---
# <a name="pagedcode-rule-wdm"></a>PagedCode 规则 (wdm)


**PagedCode**规则指定驱动程序调用[ **PAGED\_代码**](https://msdn.microsoft.com/library/windows/hardware/ff558773)宏仅当它在执行时**IRQL &lt;= APC\_级别**。
