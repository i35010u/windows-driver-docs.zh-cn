...
description: NdisAllocateNetBuffer 规则指定按替代顺序调用 NdisAllocateNetBuffer 和 NdisFreeNetBuffer。 最终的目标是确保在 MiniportHaltEx 结束时释放 NET\_缓冲区的所有实例。
