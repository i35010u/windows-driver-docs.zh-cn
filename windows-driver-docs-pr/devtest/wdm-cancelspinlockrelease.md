...
ms.locfileid: "85916814"
---
# <a name="cancelspinlockrelease-rule-wdm"></a>CancelSpinlockRelease 规则（wdm）


**CancelSpinlockRelease**规则指定在严格替换中使用对[**IoAcquireCancelSpinLock**](https://docs.microsoft.com/previous-versions/windows/hardware/drivers/ff548196(v=vs.85))和[**IoReleaseCancelSpinLock**](https://docs.microsoft.com/previous-versions/windows/hardware/drivers/ff549550(v=vs.85))的调用。 也就是说，每次调用**IoAcquireCancelSpinLock**时，都必须具有对**IoReleaseCancelSpinLock**的相应调用。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>CancelSpinlockRelease</strong>规则。</p>
使用以下步骤来运行代码分析：
<ol>
