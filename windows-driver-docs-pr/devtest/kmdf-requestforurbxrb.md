...
ms.locfileid: "72840174"
---
# <a name="requestforurbxrb-rule-kmdf"></a>RequestForUrbXrb 规则（kmdf）


如果客户端驱动程序调用[**WdfUsbTargetDeviceCreateWithParameters**](https://docs.microsoft.com/windows-hardware/drivers/ddi/wdfusb/nf-wdfusb-wdfusbtargetdevicecreatewithparameters) ，并指定客户端协定版本 USBD\_客户端协定版本客户\_端协定\_版本\_602\_\_\__9_ CONFIG structure （若要使用适用于 Windows 8 的 USB 驱动程序堆栈的新功能），在内部使用 URB 的 DDIs 仅在以下任何前提条件适用时才使用*URB 上下文*：
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">静态驱动程序验证程序</a>并指定<strong>RequestForUrbXrb</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
