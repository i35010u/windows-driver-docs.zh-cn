...
ms.locfileid: "67393027"
---
# <a name="memafterreqcompletedioctl-rule-kmdf"></a>MemAfterReqCompletedIoctl 规则 (kmdf)


**MemAfterReqCompletedIoctl**规则指定内[ *EvtIoDeviceControl* ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdfio/nc-wdfio-evt_wdf_io_queue_io_device_control)回调函数不能后我访问 framework 内存对象/O 请求完成。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](https://docs.microsoft.com/windows-hardware/drivers/devtest/static-driver-verifier)">Static Driver Verifier</a>并指定<strong>MemAfterReqCompletedIoctl</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
