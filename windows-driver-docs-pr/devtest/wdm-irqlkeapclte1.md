...
ms.date: 05/21/2018
description: '了解详细信息： IrqlKeApcLte1 规则 (wdm) '
keywords:
...
ms.openlocfilehash: 3fc7d97e6d20743503d46ad04176057101c5ae71
ms.sourcegitcommit: f47c072e88dce59daba1231027b60eb56bd2cde9
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/27/2020
ms.locfileid: "92689399"
---
...
<tbody>
<tr class="odd">
<td align="left"><p>运行 <a href="/windows-hardware/drivers/devtest/static-driver-verifier" data-raw-source="[Static Driver Verifier](./static-driver-verifier.md)">静态驱动程序验证程序</a> 并指定 <strong>IrqlKeApcLte1</strong> 规则。</p>
使用以下步骤来运行代码分析：
<ol>
