...
ms.locfileid: "56565609"
---
# <a name="evtsurpriseremovenosuspendqueue-rule-kmdf"></a>EvtSurpriseRemoveNoSuspendQueue 规则 (kmdf)


**EvtSurpriseRemoveNoSuspendQueue**规则指定 WDF 驱动程序不应清空、 停止或从队列中清除[ *EvtDeviceSurpriseRemoval* ](https://msdn.microsoft.com/library/windows/hardware/ff540913)回调函数中，应改为使用自托管的 I/O 回调函数。 *EvtDeviceSurpriseRemoval*回调函数不会同步与电源关闭路径。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>EvtSurpriseRemoveNoSuspendQueue</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
