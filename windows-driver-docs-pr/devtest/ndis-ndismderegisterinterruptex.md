...
ms.locfileid: "56524682"
---
# <a name="ndismderegisterinterruptex-rule-ndis"></a>NdisMDeregisterInterruptEx 规则 (ndis)


之后[ **NdisMDeregisterInterruptEx** ](https://msdn.microsoft.com/library/windows/hardware/ff563575)返回控件，微型端口驱动程序不能调用[ **NdisMSynchronizeWithInterruptEx** ](https://msdn.microsoft.com/library/windows/hardware/ff563681)函数。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>NdisMDeregisterInterruptEx</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
