...
description: Irql\_Filter\_Driver\_函数规则指定必须在正确的 IRQL 级别调用筛选器驱动程序的 NDIS 函数。
...
ms.locfileid: "72839395"
---
# <a name="irql_filter_driver_function-rule-ndis"></a>Irql\_筛选器\_驱动程序\_函数规则（ndis）


Irql\_Filter\_Driver\_函数规则指定必须在正确的 IRQL 级别调用筛选器驱动程序的 NDIS 函数。
