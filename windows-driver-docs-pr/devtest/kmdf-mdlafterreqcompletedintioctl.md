...
ms.locfileid: "56520413"
---
# <a name="mdlafterreqcompletedintioctl-rule-kmdf"></a>MdlAfterReqCompletedIntIoctl 规则 (kmdf)


MdlAfterReqCompletedIntIoctl 规则指定，在[ *EvtIoInternalDeviceControl* ](https://msdn.microsoft.com/library/windows/hardware/ff541768) I/O 请求之后，无法访问内存描述符列表 (MDL) 的回调函数已完成。
...
<tbody>
<tr class="odd">
<td align="left"><p>运行<a href="https://msdn.microsoft.com/library/windows/hardware/ff552808" data-raw-source="[Static Driver Verifier](https://msdn.microsoft.com/library/windows/hardware/ff552808)">Static Driver Verifier</a>并指定<strong>MdlAfterReqCompletedIntIoctl</strong>规则。</p>
使用以下步骤来分析你的代码：
<ol>
