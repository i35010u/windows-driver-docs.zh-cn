...
ms.openlocfilehash: 5a865a0bc2a5b28f6d6fba346aaab2a3f6fd17a6
ms.sourcegitcommit: 7b9c3ba12b05bbf78275395bbe3a287d2c31bcf4
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/28/2020
ms.locfileid: "89067428"
---
...
*GDI* 将导出许多可简化驱动程序设计的服务例程。 驱动程序可以直接调用这些例程。 例程的名称，这些例程的名称以 **Eng**开头。 与特定对象相关的服务例程始终以对象的名称开头;例如， [**CLIPOBJ \_ CEnumStart**](/windows/desktop/api/winddi/nf-winddi-clipobj_cenumstart) 是 [**CLIPOBJ**](/windows/desktop/api/winddi/ns-winddi-_clipobj) 服务。
