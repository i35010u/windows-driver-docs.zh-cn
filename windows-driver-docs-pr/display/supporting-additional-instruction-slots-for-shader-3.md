---
title: 有关在着色器 3 支持额外的指令槽
description: 有关在着色器 3 支持额外的指令槽
...
ms.locfileid: "56541088"
---
# <a name="supporting-additional-instruction-slots-for-shader-3"></a>有关在着色器 3 支持额外的指令槽
