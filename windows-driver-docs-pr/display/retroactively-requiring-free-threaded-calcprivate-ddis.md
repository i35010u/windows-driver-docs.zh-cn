---
title: 以追溯方式进行需要自由线程 CalcPrivate DDIs
description: 以追溯方式进行需要自由线程 CalcPrivate DDIs
...
ms.locfileid: "56554667"
---
# <a name="retroactively-requiring-free-threaded-calcprivate-ddis"></a>以追溯方式进行需要自由线程 CalcPrivate DDIs
