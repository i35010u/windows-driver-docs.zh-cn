...
显示驱动程序收到颜色值时处理 D3DDP2OP\_CLEAR 和 D3DDP2OP\_COLORFILL 操作代码中其[ **D3dDrawPrimitives2** ](https://msdn.microsoft.com/library/windows/hardware/ff544704)函数。
