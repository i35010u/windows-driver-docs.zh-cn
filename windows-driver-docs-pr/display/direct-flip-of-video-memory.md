...
-   为了确保视频播放和其他全屏方案的最佳功率消耗，直接翻转启用了最少的内存带宽来显示全屏内容，并确保全屏应用、其他应用和桌面之间的平滑转换环境.
...
-   [**D3D11\_1\_DDI\_检查\_直接\_翻转\_标志**](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/ne-d3d10umddi-d3d11_1_ddi_check_direct_flip_flags)
-   [**D3DDDI\_检查\_直接\_翻转\_标志**](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ne-d3dumddi-d3dddi_check_direct_flip_flags)
...
-   [**D3DKMT\_DIRECTFLIP\_支持**](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/ns-d3dkmthk-_d3dkmt_directflip_support)
...
有关硬件设备实现此功能时必须满足的要求的信息，请参阅相关[WHCK 文档](https://docs.microsoft.com/windows-hardware/test/hlk/windows-hardware-lab-kit)，了解**¦ DirectFlip**。
