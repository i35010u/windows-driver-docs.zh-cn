...
驱动程序将填充 [**DD \_ SURFACECALLBACKS**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surfacecallbacks) 结构的成员，以指示它支持以下回调函数。
...
驱动程序将填充 [**DD \_ PALETTECALLBACKS**](/windows/win32/api/ddrawint/ns-ddrawint-dd_palettecallbacks) 结构的成员，以指示它支持以下回调函数。
