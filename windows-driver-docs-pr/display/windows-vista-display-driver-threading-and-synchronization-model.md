...
- Windows Vista 显示器驱动程序模型 WDK，线程处理
- 显示驱动程序模型 WDK Windows Vista 中，同步
...
下面的主题介绍显示器驱动程序线程和同步模型为 Windows 显示驱动程序模型 (WDDM):

[线程处理和显示微型端口驱动程序的同步模型](threading-and-synchronization-model-of-display-miniport-driver.md)

[线程处理模型的用户模式显示驱动程序](threading-model-of-user-mode-display-driver.md)
