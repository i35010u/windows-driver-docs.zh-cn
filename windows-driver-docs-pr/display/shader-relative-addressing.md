...
-   仅 D3DSPR\_ADDR 或 D3DSPR\_循环可用作[注册类型](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3d9types/ne-d3d9types-_d3dshader_param_register_type)。
