...
上的以下限制[ **DXVA\_ConnectMode** ](https://msdn.microsoft.com/library/windows/hardware/ff563138)结构时，适用[bDXVA\_Func 变量](bdxva-func-variable.md)中定义**dwFunction**的成员[ **DXVA\_ConfigPictureDecode** ](https://msdn.microsoft.com/library/windows/hardware/ff563133)结构是否等于 1。
