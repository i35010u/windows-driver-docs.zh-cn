...
-   [*DxgkDdiCollectDbgInfo*](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmddi/nc-d3dkmddi-dxgkddi_collectdbginfo)
    **请注意**，  [*DxgkDdiCollectDbgInfo*](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmddi/nc-d3dkmddi-dxgkddi_collectdbginfo)应收集各种故障的调试信息，并且可随时调用，并且在高 IRQL （也就是说， *DxgkDdiCollectDbgInfo*运行的 irql 通常是未定义的）。 在任何情况下， *DxgkDdiCollectDbgInfo*必须验证所需的调试信息的可用性和正确的同步。 但是，如果[ **\_DXGKARG**](https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmddi/ns-d3dkmddi-_dxgkarg_collectdbginfo)的 pCollectDbgInfo 参数\_参数设置为 "[视频 TDR\_超时\_检测](https://docs.microsoft.com/windows-hardware/drivers/debugger/bug-check-code-reference2)到或[视频\_引擎\_检测到超时](https://docs.microsoft.com/windows-hardware/drivers/debugger/bug-check-code-reference2)，则驱动程序必须确保*DxgkDdiCollectDbgInfo*是可分页的，并支持**同步零级别**。\_\_
