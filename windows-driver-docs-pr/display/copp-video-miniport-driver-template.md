...
本部分中提供的代码示例演示一种用于访问 COPP 功能 COPP 微型端口驱动程序代码模板实现。 使用此模板可以简化微型端口驱动程序开发。 但是，您不需要您的微型端口驱动程序才能正常工作的这种方式实现对 COPP 功能的访问。
...
[COPP 视频微型端口驱动程序打开模板代码](copp-video-miniport-driver-open-template-code.md)
...
[COPP 视频微型端口驱动程序序列开始模板代码](copp-video-miniport-driver-sequence-start-template-code.md)
