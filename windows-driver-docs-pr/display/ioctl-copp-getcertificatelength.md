...
**PpThis**成员指向指向 COPP DirectX VA 设备对象，该对象用于检索硬件证书的大小。 **InputBuffer**成员不需要。 **Phr**成员应设置为从返回的值[ *COPPGetCertificateLength* ](https://msdn.microsoft.com/library/windows/hardware/ff539644)函数。
...
微型端口驱动程序集**信息**的成员[**状态\_阻止**](https://msdn.microsoft.com/library/windows/hardware/ff569732) sizeof(ULONG) 的结构。
