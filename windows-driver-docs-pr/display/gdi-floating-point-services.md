...
ms.openlocfilehash: b7b4416bab1c7852f191bfb226984f60790f9e01
ms.sourcegitcommit: 7b9c3ba12b05bbf78275395bbe3a287d2c31bcf4
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/28/2020
ms.locfileid: "89065834"
---
...
内核模式图形驱动程序必须在调用 GDI 提供的 [**EngSaveFloatingPointState**](/windows/desktop/api/winddi/nf-winddi-engsavefloatingpointstate) 和 [**EngRestoreFloatingPointState**](/windows/desktop/api/winddi/nf-winddi-engrestorefloatingpointstate) 例程之间执行所有浮点运算。

如果硬件具有浮点处理器，则驱动程序可以直接执行浮点运算。 否则，驱动程序可以使用下表中所示的 GDI [**FLOATOBJ**](/windows/desktop/api/winddi/ns-winddi-_floatobj) 服务来模拟浮点运算。 无论采用哪种处理器类型，驱动程序在声明浮点值时都应使用 FLOATL 数据类型。
