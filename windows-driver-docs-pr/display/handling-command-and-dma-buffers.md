...
[使用有保证的协定 DMA 缓冲区模型](using-the-guaranteed-contract-dma-buffer-model.md)

[分页视频内存资源](paging-video-memory-resources.md)

[提交命令缓冲区](submitting-a-command-buffer.md)
...
[准备 DMA 缓冲区](preparing-dma-buffers.md)
