...
description: 本部分介绍 PrintTicket PageMediaSize 选项和 GPD/PPD 文件条目之间的默认映射。
...
ms.locfileid: "63355685"
---
# <a name="default-pagemediasize-mappings"></a>默认 PageMediaSize 映射


本部分介绍 PrintTicket PageMediaSize 选项和 GPD/PPD 文件条目之间的默认映射。

| PageMediaSize 值                           | GPD/PPD 文件条目          |
|-----------------------------------------------|-----------------------------|
| PrintTicket CustomMediaSize                   | GPD CUSTOMSIZE              |
| PrintTicket NorthAmerica10x11                 | GPD 10X11                   |
| PrintTicket NorthAmerica10x14                 | GPD 10 X 14                   |
| PrintTicket NorthAmerica11x17                 | GPD 11 X 17                   |
| PrintTicket NorthAmerica9x11                  | GPD 9 X 11                    |
| PrintTicket NorthAmericaSuperA                | GPD A\_加上                 |
...
| PrintTicket JapanDoubleHagakiPostcard         | GPD 双\_日语\_明信片 |
...
| PrintTicket OtherMetricInviteEnvelope         | GPD ENV\_邀请             |
| PrintTicket OtherMetricItalianEnvelope        | GPD ENV\_意大利              |
| PrintTicket NorthAmericaMonarchEnvelope       | GPD ENV\_君主式            |
| PrintTicket NorthAmericaPersonalEnvelope      | GPD ENV\_个人           |
| PrintTicket NorthAmericaESheet                | GPD 项工作表信封                  |
| PrintTicket NorthAmericaExecutive             | GPD 高级管理人员               |
| PrintTicket NorthAmericaGermanLegalFanfold    | GPD 复写纸\_LGL\_德语    |
| PrintTicket NorthAmericaGermanStandardFanfold | GPD 复写纸\_STD\_德语    |
| PrintTicket OtherMetricFolio                  | GPD 对开                   |
| PrintTicket ISOB4                             | GPD ISO\_B4                 |
| PrintTicket JapanHagakiPostcard               | GPD 日语\_明信片      |
...
| PrintTicket NorthAmericaLegalExtra            | GPD 法律\_额外            |
| PrintTicket NorthAmericaLetter                | GPD 字母                  |
| PrintTicket NorthAmericaLetterExtra           | GPD 字母\_额外           |
| PrintTicket NorthAmericaLetterPlus            | GPD 字母\_加上            |
| PrintTicket NorthAmericaNote                  | GPD 注意                    |
...
| PrintTicket NorthAmericaTabloidExtra          | GPD TABLOID\_额外          |
