...
<td><p>可选。 如果未指定，则默认值为<strong>TRUE</strong> （对于 *<strong>DrvBPP</strong> &gt; 1）。 若要创建灰色缩放，请将 *<strong>DrvBPP</strong>设置为<strong>FALSE</strong> ，&gt; 1。</p></td>
</tr>
<tr class="even">
<td><p></em><strong>ColorPlaneOrder</strong></p></td>
<td><p>指示 Unidrv 应发送颜色平面数据的顺序的列表。</p>
<p>示例：</p>
LIST （黄色、洋红色、青色、黑色）列表（红色、绿色、蓝色）
<p>可在列表中重复颜色。</p></td>
...
<td><p>可选。 如果未指定，则默认值为1。 （对于彩色打印机，值为1称为像素模式。）</p></td>
</tr>
<tr class="odd">
