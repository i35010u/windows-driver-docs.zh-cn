---
title: TVOT \_ COMBOBOX
description: TVOT \_ COMBOBOX
keywords:
- TVOT_COMBOBOX 打印设备
topic_type:
- apiref
...
ms.openlocfilehash: 064e00d2833c6fc6d0a6051082019e7860f50418
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96831223"
---
# <a name="tvot_combobox"></a>TVOT \_ COMBOBOX


## <span id="ddk_tvot_combobox_gg"></span><span id="DDK_TVOT_COMBOBOX_GG"></span>


TVOT \_ COMBOBOX 选项类型包括分组框中的组合框。
...
**pOptParam** \[*n* \] - n &gt;**pData** 指向要在组合框中显示的第 *n* 个文本字符串。
...
如果设置此参数，则在组合框中显示参数的值时，CPSUI 不会在 OPTPARAM) 中 (**IconID** 绘制每个选项参数的图标。

<span id="OTS_LBCB_PROPPAGE_CBUSELB"></span><span id="ots_lbcb_proppage_cbuselb"></span>OTS \_ LBCB \_ 属性页 \_ CBUSELB  
