---
title: 基于 GDI 的、 整体化打印驱动程序中的打印功能支持
description: 基于 GDI 的、 整体化打印驱动程序中的打印功能支持
...
ms.locfileid: "56534153"
---
# <a name="print-capabilities-support-in-gdi-based-monolithic-print-drivers"></a>基于 GDI 的、 整体化打印驱动程序中的打印功能支持
