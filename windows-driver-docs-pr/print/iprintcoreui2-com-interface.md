...
`IPrintCoreUI2` COM 接口扩展了[IPRINTOEMDRIVERUI com 接口](iprintoemdriverui-com-interface.md)。 在 Windows XP 和更高版本中，Pscript5 驱动程序提供 `IPrintCoreUI2` COM 接口。 此接口中的方法仅供 Pscript5 UI 插件使用。
