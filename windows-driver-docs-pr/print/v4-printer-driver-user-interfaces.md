...
UWP 的设备应用程序支持 Microsoft Store 应用程序 UI 中的 v4 打印驱动程序。 有关开发 UWP 设备应用程序的详细信息，请参阅[开发 UWP 设备应用用于打印](https://docs.microsoft.com/windows-hardware/drivers/devapps/windows-store-device-apps-for-printers)。
