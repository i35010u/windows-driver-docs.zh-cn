...
将 \***PreAnalysisOptions**参数设置为4可允许 Unidrv 直接将[**DrvStretchBlt**](https://docs.microsoft.com/windows/desktop/api/winddi/nf-winddi-drvstretchblt)调用下载到支持 stretchblt 操作的设备。
