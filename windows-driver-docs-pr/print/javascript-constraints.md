...
\[在中\]\[出\] [ **IPrintSchemaCapabilities** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/printerextension/nn-printerextension-iprintschemacapabilities)对象，表示由配置模块生成的基 PrintCapabilities 对象。
返回值
