...
如果设置此属性，则始终启用 "推送" 按钮，即使用户无法修改属性表页 (也是如此，即使 \_ \_ 未在 [**COMPROPSHEETUI**](/windows-hardware/drivers/ddi/compstui/ns-compstui-_compropsheetui) 结构) 中设置 CPSUIF UPDATE 权限也是如此。
