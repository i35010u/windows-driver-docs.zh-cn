---
title: 在快照中允许的字符的 XML 限制
description: 在快照中允许的字符的 XML 限制
...
ms.locfileid: "56525070"
---
# <a name="xml-restrictions-on-allowed-characters-in-snapshots"></a>在快照中允许的字符的 XML 限制
