...
1.  请按照 Microsoft [bidi 通信架构](https://msdn.microsoft.com/library/windows/hardware/ff545175)并[bidi 通信接口](https://msdn.microsoft.com/library/windows/hardware/ff545163)Windows SDK 文档中所述。

2.  支持打印机\_事件\_配置\_中的更新打印机事件[ **DrvPrinterEvent** ](https://msdn.microsoft.com/library/windows/hardware/ff548564)函数。
