...
本部分中描述的功能的 PCMCIA\_接口\_标准接口，该 PCMCIA 总线驱动程序支持在 Windows 2000 和更高版本操作系统中。 PCMCIA\_接口\_标准接口提供了一组可以直接通过 PCMCIA 驱动程序调用的例程。 这些接口例程支持以下操作：

-   修改映射由 PCMCIA 总线驱动程序内存窗口的属性
