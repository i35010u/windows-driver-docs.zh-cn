...
设置 [Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf) 工具的属性。 生成驱动程序时，你可以使用 Stampinf 来更新常用的 INF 和 INX 文件指令。
...
如果你想要将此属性页添加到你的项目，以便你可以在生成过程中运行 Stampinf，请参阅 [WDK 和 Visual Studio 生成环境](https://docs.microsoft.com/windows-hardware/drivers/devtest/wdk-and-visual-studio-build-environment)和 [Stampinf 任务](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)。
...
<td align="left"><p>指定在 <a href="https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive" data-raw-source="[&lt;strong&gt;INF DriverVer directive&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive)"><strong>INF DriverVer 指令</strong></a>中写入的日期。 日期格式为<em>月</em>/<em>日</em>/<em>年</em>（例如，<strong>10/20/2011</strong>）。</p>
...
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-d [</strong><em>date</em><strong>|</em>]</strong>。</p>
<div class="alert">
...
<td align="left"><p>指定要在其中放置 <a href="https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive" data-raw-source="[&lt;strong&gt;INF DriverVer directive&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/install/inf-driverver-directive)"><strong>INF DriverVer 指令</strong></a>的 INF 部分。 此指令所在的默认位置是 <a href="https://docs.microsoft.com/windows-hardware/drivers/install/inf-version-section" data-raw-source="[&lt;strong&gt;INF Version section&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/install/inf-version-section)"><strong>INF Version 部分</strong></a>。</p>
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-s</strong> <em>section</em>。</p></td>
</tr>
<tr class="even">
...
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-k</strong> <em>KMDFversion</em>。</p></td>
</tr>
<tr class="odd">
...
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-u</strong> <em>UMDFversion</em>。</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>指定在 <a href="https://docs.microsoft.com/windows-hardware/drivers/install/inf-version-section" data-raw-source="[&lt;strong&gt;INF Version section&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/install/inf-version-section)"><strong>INF Version 部分</strong></a>中的 <strong>CatalogFile</strong> 指令中写入的值。 默认情况下不写入 <strong>CatalogFile</strong> 指令。</p>
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-c</strong> <em>catalogfile</em>。</p></td>
</tr>
<tr class="odd">
...
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-n</strong>。</p></td>
</tr>
<tr class="even">
...
<p>此设置相当于指定 <a href="https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf" data-raw-source="[Stampinf](https://docs.microsoft.com/windows-hardware/drivers/devtest/stampinf)">Stampinf</a> 选项 <strong>-i</strong> <em>path</em>。</p></td>
</tr>
</tbody>
</table>
...
* [**INF Version 部分**](https://docs.microsoft.com/windows-hardware/drivers/install/inf-version-section)
...
* [How to:在生成时使用环境变量](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-environment-variables-in-a-build?view=vs-2015)。
