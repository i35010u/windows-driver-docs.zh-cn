...
有关详细信息，请参阅[运行完成安装操作](https://docs.microsoft.com/windows-hardware/drivers/install/running-finish-install-actions)。
...
句柄[设备信息集](https://docs.microsoft.com/windows-hardware/drivers/install/device-information-sets)，其中包含要安装的设备。

<a href="" id="deviceinfodata"></a>*DeviceInfoData*  
一个指向[ **SP_DEVINFO_DATA** ](https://docs.microsoft.com/windows/desktop/api/setupapi/ns-setupapi-_sp_devinfo_data)结构，它表示要安装的设备。

<a href="" id="device-installation-parameters-"></a>设备安装参数   
设备安装参数 ( [ **SP_DEVINSTALL_PARAMS** ](https://docs.microsoft.com/windows/desktop/api/setupapi/ns-setupapi-_sp_devinstall_params_a)结构) 与关联*DeviceInfoData*。
...
使用 Windows 7 [ **SetupDiFinishInstallAction**](https://docs.microsoft.com/previous-versions/windows/hardware/previsioning-framework/ff551022(v=vs.85))。

没有默认值 DIF 代码处理程序在 Windows 8 和更高版本，并[ **SetupDiFinishInstallAction** ](https://docs.microsoft.com/previous-versions/windows/hardware/previsioning-framework/ff551022(v=vs.85))已删除。

### <a name="comments"></a>备注

因为设备安装不能确定从 ERROR_DI_DO_DEFAULT 返回代码或 NO_ERROR 返回代码完成安装操作是否实际成功，安装程序应通知用户完成安装程序操作的状态。

完成安装操作的详细信息，请参阅[如何设备安装进程完成安装操作](https://docs.microsoft.com/windows-hardware/drivers/install/how-finish-install-actions-are-processed)并[实现完成安装操作](https://docs.microsoft.com/windows-hardware/drivers/install/implementing-finish-install-actions)。

有关差异代码的常规信息，请参阅[处理 DIF 代码](https://docs.microsoft.com/windows-hardware/drivers/install/handling-dif-codes)并[调用默认的 DIF 代码处理程序](https://docs.microsoft.com/windows-hardware/drivers/install/calling-the-default-dif-code-handlers)。
