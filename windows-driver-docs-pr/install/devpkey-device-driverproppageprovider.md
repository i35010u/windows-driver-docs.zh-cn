...
ms.date: 10/17/2018
ms.openlocfilehash: 0c646a933672ec212a6f36fa825686d2d174be5a
ms.sourcegitcommit: 4db5f9874907c405c59aaad7bcc28c7ba8280150
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2020
ms.locfileid: "89096455"
---
...
你可以使用 inf [**AddReg 指令**](./inf-addreg-directive.md) 设置 DEVPKEY_Device_DriverPropPageProvider 的值，该指令包含用于安装设备的 inf 文件的 [**inf *DDInstall* 部分**](./inf-ddinstall-section.md) 。

可以通过调用 [**SetupDiGetDeviceProperty**](/windows/desktop/api/setupapi/nf-setupapi-setupdigetdevicepropertyw)来检索 DEVPKEY_Device_DriverPropPageProvider 的值。

Windows Server 2003、Windows XP 和 Windows 2000 支持此属性，但不支持 DEVPKEY_Device_DriverPropPageProvider 属性键。 在这些早期版本的 Windows 上，可以通过访问设备实例的软件密钥下的相应 **EnumPropPages32** 注册表值来访问此属性的值。 有关如何在这些早期版本的 Windows 上访问此属性值的信息，请参阅 [访问设备驱动程序属性](./accessing-device-driver-properties.md)。
