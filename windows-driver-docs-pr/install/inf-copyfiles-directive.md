...
ms.openlocfilehash: 6e6d245d76eef71a9676c8424422e13d212f51c6
ms.sourcegitcommit: 4db5f9874907c405c59aaad7bcc28c7ba8280150
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2020
ms.locfileid: "89097361"
---
...
-   在 DDInstall * 中由 INF [**AddInterface**](inf-addinterface-directive.md)指令引用的*添加接口部分* [ * **。接口**](inf-ddinstall-interfaces-section.md)部分。
...
此示例演示如何在 DDInstall 中使用**CopyFiles**指令[ * **。**](inf-ddinstall-coinstallers-section.md)设备驱动程序的 Inf 的 CoInstallers 部分，提供两个特定于设备的共同安装程序来补充特定于系统设备类型的类安装程序的 inf 处理。
