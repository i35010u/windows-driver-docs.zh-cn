...
ms.locfileid: "56576132"
---
# <a name="guiddevinterfaceusbdevice"></a>GUID_DEVINTERFACE_USB_DEVICE


GUID_DEVINTERFACE_USB_DEVICE[设备接口类](https://msdn.microsoft.com/library/windows/hardware/ff541339)为定义[USB 设备](https://msdn.microsoft.com/library/windows/hardware/ff538930)，附加到的 USB 集线器。
