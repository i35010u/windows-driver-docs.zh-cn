...
ms.date: 10/17/2018
ms.openlocfilehash: 9c1909adcedf36c2692ed49db47d51d0e6d0d676
ms.sourcegitcommit: 0cc5051945559a242d941a6f2799d161d8eba2a7
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2019
ms.locfileid: "63391672"
---
# <a name="ksmftcategoryother"></a>KSMFT_CATEGORY_OTHER


KSMFT_CATEGORY_OTHER[设备接口类](https://msdn.microsoft.com/library/windows/hardware/ff541339)为定义[内核流式处理](https://msdn.microsoft.com/library/windows/hardware/ff560842)(KS) 不属于其他 KS 功能类别中的设备的功能类别。
