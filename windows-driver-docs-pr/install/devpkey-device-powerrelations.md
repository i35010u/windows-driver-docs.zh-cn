...
DEVPKEY_Device_PowerRelations 设备属性表示设备实例的 [**电源关系**](../kernel/irp-mn-query-device-relations.md) 。
...
可以调用 [**SetupDiGetDeviceProperty**](/windows/win32/api/setupapi/nf-setupapi-setupdigetdevicepropertyw) 来检索 DEVPKEY_Device_PowerRelations 的值。
