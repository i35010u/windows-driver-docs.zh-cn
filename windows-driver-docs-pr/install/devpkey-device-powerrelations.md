...
ms.date: 10/17/2018
ms.openlocfilehash: 388a6d47412a36b7801c0ddddd1c6c2eda5b33c1
ms.sourcegitcommit: e180a0670b0b78c30541755e6e030df249979f1e
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/16/2020
ms.locfileid: "86418198"
---
# <a name="devpkey_device_powerrelations"></a>DEVPKEY_Device_PowerRelations


DEVPKEY_Device_PowerRelations 设备属性表示设备实例的[**电源关系**](https://docs.microsoft.com/windows-hardware/drivers/kernel/irp-mn-query-device-relations)。
...
可以调用[**SetupDiGetDeviceProperty**](https://docs.microsoft.com/windows/desktop/api/setupapi/nf-setupapi-setupdigetdevicepropertyw)来检索 DEVPKEY_Device_PowerRelations 的值。
