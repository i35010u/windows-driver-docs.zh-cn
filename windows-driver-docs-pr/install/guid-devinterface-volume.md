...
ms.date: 10/17/2018
ms.openlocfilehash: 75b3c8d1726e151e649944626f05f5a26b0a9381
ms.sourcegitcommit: 4db5f9874907c405c59aaad7bcc28c7ba8280150
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2020
ms.locfileid: "89096879"
---
...
WDK 中的存储 [示例](https://go.microsoft.com/fwlink/p/?LinkId=618052) 包括一个 [Addfilter 存储筛选器工具](https://go.microsoft.com/fwlink/p/?linkid=256076) ，该工具使用过时的标识符 [**VolumeClassGuid**](volumeclassguid.md) 来枚举 GUID_DEVINTERFACE_VOLUME 设备接口类的实例。
