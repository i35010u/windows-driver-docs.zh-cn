...
ms.locfileid: "63390739"
---
# <a name="kscategorynetwork"></a>KSCATEGORY_NETWORK


KSCATEGORY_NETWORK[设备接口类](https://msdn.microsoft.com/library/windows/hardware/ff541339)为定义[内核流式处理](https://msdn.microsoft.com/library/windows/hardware/ff568277)(KS) 网络设备的功能类别。
