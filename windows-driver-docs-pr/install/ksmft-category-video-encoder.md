...
为视频设备的[内核流式处理](../stream/kernel-streaming.md) (KS) 功能类别定义 KSMFT_CATEGORY_VIDEO_ENCODER[设备接口类](./overview-of-device-interface-classes.md)。
...
具有 MFT 编解码器的 AVStream 驱动程序支持注册此设备接口类的实例，以指示操作系统设备支持 KSMFT_CATEGORY_VIDEO_ENCODER 功能类别。
