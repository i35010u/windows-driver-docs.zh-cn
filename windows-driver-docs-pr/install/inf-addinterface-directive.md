...
ms.openlocfilehash: bcedc68e7155c23ba5808bb49355e850a52011a7
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96840063"
---
...
指定标识设备接口类的 GUID 值。 这可以表示为 **{**<em>nnnnnnnn</em> **-** _nnnn_ *_-_* _nnnn_ - ** **-** <em>nnnnnnnnnnnn</em>* *}** 形式的显式 GUID 值，或在 INF 文件的字符串部分 *strkey* 中定义为 **"{**<em>nnnnnnnn</em> **-** _nnnn_ *_-_* _nnnn_ - ** **-** <em>nnnnnnnnnnnn</em>* ** [**Strings**](inf-strings-section.md)
