...
ms.openlocfilehash: 661ec512ca9d9d5b3f74262e6f9e8643c18ced5f
ms.sourcegitcommit: 4db5f9874907c405c59aaad7bcc28c7ba8280150
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2020
ms.locfileid: "89095503"
---
...
对于任何标准类型的设备，此名称指定设备 [安装程序类](./overview-of-device-setup-classes.md) 的名称，该类型是使用该 INF 文件安装的设备的类型。 此名称通常是系统定义的类名称之一，例如 **Net** 或 **Display，** 它们列在 *Devguid*中。 有关详细信息，请参阅 [系统提供的设备安装程序类](/previous-versions/ff553419(v=vs.85))。
...
<a href="" id="classguid--nnnnnnnn-nnnn-nnnn-nnnn-nnnnnnnnnnnn-"></a>**ClassGuid = {**<em>nnnnnnnn</em>** - ***nnnn*** - ***nnnn*** - ***nnnn***nnnn - **nnnn<em>nnnnnnnnnnnn</em>**}**  
