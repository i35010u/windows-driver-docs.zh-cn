...
ms.locfileid: "67385300"
---
# <a name="authenticode-signing-of-third-party-csps"></a>对第三方 CSP 进行验证码签名


通过第三方验证码签名的自定义加密服务提供商 (Csp) 已被 Windows Vista 开始提供，并返回已移植到 Windows XP SP3 和 Windows Server 2003 SP2 截至 2013 年 5 月， [此下载](https://support.microsoft.com/help/2836198).
...
2.  从 CA 和匹配的交叉证书的证书后，可以使用[ **SignTool** ](https://docs.microsoft.com/windows-hardware/drivers/devtest/signtool)登录所有 CSP 二进制文件。
...
为命令[ **SignTool** ](https://docs.microsoft.com/windows-hardware/drivers/devtest/signtool)是：
...
您还可以检查[Windows 桌面应用程序安全](https://social.msdn.microsoft.com/Forums/home?forum=windowssecurity)论坛以获得帮助。
