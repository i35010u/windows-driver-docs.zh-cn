...
### <a name="span-idsupportedlocalelistelementspanspan-idsupportedlocalelistelementspanspan-idsupportedlocalelistelementspansupportedlocalelist-element"></a><span id="SupportedLocaleList_Element"></span><span id="supportedlocalelist_element"></span><span id="SUPPORTEDLOCALELIST_ELEMENT"></span>SupportedLocaleList 元素
...
### <a name="span-idlocaleelementspanspan-idlocaleelementspanspan-idlocaleelementspanlocale-element"></a><span id="Locale_Element"></span><span id="locale_element"></span><span id="LOCALE_ELEMENT"></span>Locale 元素

Locale 元素指定在设备元数据包中支持的额外区域设置。 有关合作伙伴中心如何使用此值的详细信息，请参阅“SupportedLocaleList 元素”。

## <a name="span-idlocaleinfoxmlexamplespanspan-idlocaleinfoxmlexamplespanspan-idlocaleinfoxmlexamplespanlocaleinfo-xml-example"></a><span id="LocaleInfo_XML_Example"></span><span id="localeinfo_xml_example"></span><span id="LOCALEINFO_XML_EXAMPLE"></span>LocaleInfo XML 示例
