...
ms.topic: article
description: 在 Windows 硬件开发人员中心仪表板中管理用户角色
ms.date: 04/20/2017
...
ms.locfileid: "56518295"
---
# <a name="managing-user-roles"></a>管理用户角色


Windows 硬件开发人员中心仪表板使你可以为你的每个用户分配特定角色。 以下角色适用于仪表板用户：
...
![显示 Windows 硬件开发人员中心内“管理用户”菜单的图像](images/manage-users.png)
