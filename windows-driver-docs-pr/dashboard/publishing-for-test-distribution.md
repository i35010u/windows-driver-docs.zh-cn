...
## <a name="span-idclientpcconfigurationspanspan-idclientpcconfigurationspanspan-idclientpcconfigurationspanclient-pc-configuration"></a><span id="Client_PC_configuration"></span><span id="client_pc_configuration"></span><span id="CLIENT_PC_CONFIGURATION"></span>客户端电脑配置
