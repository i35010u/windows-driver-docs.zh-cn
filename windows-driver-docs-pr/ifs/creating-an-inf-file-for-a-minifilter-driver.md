...
**ServiceType**条目指定服务的类型。 微筛选器驱动程序应将值指定为 2 (SERVICE_FILE_SYSTEM_DRIVER) 。 有关 **ServiceType** 条目的详细信息，请参阅 [INF AddService 指令](https://docs.microsoft.com/windows-hardware/drivers/install/inf-addservice-directive)。
