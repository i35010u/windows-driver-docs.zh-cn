...
*lpOutBuffer* \[out\]  
指向接收缓冲区的指针[ **FSCTL\_查询\_卷\_NUMA\_信息\_输出**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/ns-ntifs-_fsctl_query_volume_numa_info_output)结构，它指定在无将统一内存体系结构 (NUMA) 卷的当前节点。
...
[**FSCTL\_查询\_卷\_NUMA\_信息\_输出**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/ns-ntifs-_fsctl_query_volume_numa_info_output)
