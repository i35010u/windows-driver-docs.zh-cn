...
-   最终用户可以指定的卷进行筛选，例如，键入卷的驱动器号。 最终用户的命令中继到筛选器驱动程序，因为私有[ **IRP\_MJ\_设备\_控制**](https://msdn.microsoft.com/library/windows/hardware/ff548649)请求。

-   文件系统筛选器驱动程序可以将附加到一个或多个文件系统驱动程序，侦听[ **IRP\_MJ\_文件\_系统\_控制**](https://msdn.microsoft.com/library/windows/hardware/ff548670)，IRP\_MN\_装载\_批量请求，并将附加到卷，因为它们已装载。
