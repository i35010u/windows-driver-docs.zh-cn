...
指向调用方分配的指针[**文件\_FS\_的永久\_卷\_信息**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/ns-ntifs-_file_fs_persistent_volume_information)结构。

<a href="" id="inputbufferlength"></a>*InputBufferLength*  
大小 （字节） 通过指向的缓冲区*InputBuffer*参数。

<a href="" id="outputbuffer"></a>*OutputBuffer*  
指向调用方分配的指针[**文件\_FS\_的永久\_卷\_信息**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntifs/ns-ntifs-_file_fs_persistent_volume_information)结构，它接收永久设置文件系统卷。
