...
ms.locfileid: "67370121"
---
# <a name="mrxlowiosubmitlowioopread-routine"></a>MRxLowIOSubmit\[LOWIO\_OP\_读取\]例程


*MRxLowIOSubmit\[LOWIO\_OP\_读取\]* 调用例程[RDBSS](https://docs.microsoft.com/windows-hardware/drivers/ifs/the-rdbss-driver-and-library)网络微型重定向到发出读取的请求。
