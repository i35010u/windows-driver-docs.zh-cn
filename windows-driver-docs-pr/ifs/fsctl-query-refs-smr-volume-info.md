...
*lpOutBuffer* \[out\]  
指向接收缓冲区的指针[ **REFS\_SMR\_卷\_信息\_输出**](https://msdn.microsoft.com/library/windows/hardware/mt842919)在空间指定的卷的当前状态的结构和垃圾回收活动。
...
[**REFS\_SMR\_卷\_信息\_输出**](https://msdn.microsoft.com/library/windows/hardware/mt842919)

[**REFS\_SMR\_卷\_GC\_状态**](https://msdn.microsoft.com/library/windows/hardware/mt842918)
