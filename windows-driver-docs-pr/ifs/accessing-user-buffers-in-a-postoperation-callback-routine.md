---
title: 访问 Postoperation 回调例程中的用户缓冲区
description: 访问 Postoperation 回调例程中的用户缓冲区
...
ms.locfileid: "56522531"
---
# <a name="accessing-user-buffers-in-a-postoperation-callback-routine"></a>访问 Postoperation 回调例程中的用户缓冲区
