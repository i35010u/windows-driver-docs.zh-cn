...
由 WMI 工具套件编译时，此类定义生成[**HBAFC3MgmtInfo**](https://docs.microsoft.com/windows-hardware/drivers/ddi/hbapiwmi/ns-hbapiwmi-_hbafc3mgmtinfo)数据结构。 没有与此 WMI 类相关联的方法。
