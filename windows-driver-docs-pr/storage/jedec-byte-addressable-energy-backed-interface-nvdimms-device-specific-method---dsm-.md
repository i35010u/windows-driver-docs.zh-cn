---
title: JEDEC 字节可寻址能源支持接口 NVDIMM 特定于设备的方法 (\_DSM)
description: 本部分介绍特定于设备的方法 (\_DSM) 与实现 JEDEC 字节可寻址能源支持接口标准的 NVDIMM ACPI Namespace 设备关联的接口。
...
本部分介绍特定于设备的方法 (\_DSM) 与实现 JEDEC 字节可寻址能源支持接口标准的 NVDIMM ACPI Namespace 设备关联的接口。 支持的 JEDEC 字节可寻址能源支持接口标准，NVDIMM N 具有字节可寻址能源支持 (0x1) 的函数类和函数接口值为 0x1。
