---
title: Storport I/O 模型中的映射缓冲区的使用
description: Storport I/O 模型中的映射缓冲区的使用
...
ms.locfileid: "56534197"
---
# <a name="use-of-mapping-buffers-in-the-storport-io-model"></a>Storport I/O 模型中的映射缓冲区的使用
