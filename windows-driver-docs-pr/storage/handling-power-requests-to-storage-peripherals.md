---
title: 处理与存储外围设备的 Power 请求
description: 处理与存储外围设备的 Power 请求
...
ms.locfileid: "56545253"
---
# <a name="handling-power-requests-to-storage-peripherals"></a>处理与存储外围设备的 Power 请求
