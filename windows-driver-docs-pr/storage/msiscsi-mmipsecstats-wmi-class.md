...
MSiSCSI \_ MMIPSECSTATS WMI 类公开主模式 IPsec 统计信息。
...
当 WMI 工具套件编译上述类定义时，它会生成 [**MSiSCSI \_ MMIPSECStats**](/windows-hardware/drivers/ddi/iscsiprf/ns-iscsiprf-_msiscsi_mmipsecstats) 数据结构。
