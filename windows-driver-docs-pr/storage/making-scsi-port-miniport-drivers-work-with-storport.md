---
title: Storport 制定 SCSI 端口微型端口驱动程序处理
description: Storport 制定 SCSI 端口微型端口驱动程序处理
...
ms.locfileid: "56542108"
---
# <a name="making-scsi-port-miniport-drivers-work-with-storport"></a>Storport 制定 SCSI 端口微型端口驱动程序处理
