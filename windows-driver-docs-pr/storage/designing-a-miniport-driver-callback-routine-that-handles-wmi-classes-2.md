...
description: 设计处理 WMI 类的方法的微型端口驱动程序回调例程
...
ms.locfileid: "56520994"
---
# <a name="designing-a-miniport-driver-callback-routine-that-handles-wmi-classes-with-methods"></a>设计处理 WMI 类的方法的微型端口驱动程序回调例程
