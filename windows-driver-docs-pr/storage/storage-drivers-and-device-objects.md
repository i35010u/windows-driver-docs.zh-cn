...
存储端口驱动程序创建 FILE_DEVICE_MASS_STORAGE 类型的物理设备对象（PDOs）。 Disk 类、CD-ROM 类、磁带类和变换器类驱动程序分别创建 FDOs 类型 FILE_DEVICE_DISK、FILE_DEVICE_CD_ROM、FILE_DEVICE_TAPE 和 FILE_DEVICE_CHANGER。
