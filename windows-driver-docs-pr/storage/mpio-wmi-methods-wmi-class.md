---
title: MPIO\_WMI\_方法 WMI 类
description: MPIO\_WMI\_方法 WMI 类
ms.assetid: 21ad0846-a11d-4e2e-90b9-ad23870a8225
ms.localizationpriority: medium
ms.date: 10/17/2018
ms.openlocfilehash: 2fccf563dd4c4e0d439ffb9241ab09a05357ce83
ms.sourcegitcommit: a33b7978e22d5bb9f65ca7056f955319049a2e4c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/31/2019
ms.locfileid: "56525491"
---
# <a name="mpiowmimethods-wmi-class"></a>MPIO\_WMI\_方法 WMI 类


MPIO 驱动程序使用 MPIO\_WMI\_方法 WMI 类，以向 WMI 客户端提供各种服务。

此 WMI 类都有无数据块。 因此，WMI 工具套件生成包含属于此类的方法的参数数据的结构，但它不会生成对应于类本身的结构。

每个方法都属于此类的 MOF 文件语法所述的方法的参考页。 以下部分介绍了这些方法和其随附的结构：
