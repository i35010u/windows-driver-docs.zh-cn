---
title: MSFC\_HBAFCPInfo WMI 类
description: MSFC\_HBAFCPInfo WMI 类
...
WMI 客户端使用 MSFC\_HBAFCPInfo 类，如 T11 委员会关于 FCP 信息函数的部分中定义查询光纤通道协议 (FCP) 信息的 HBA 微型端口驱动程序*光纤通道 HBA API*规范。
