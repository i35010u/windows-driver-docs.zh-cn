...
ms.openlocfilehash: 15e362bec9d8c8383d0ad2166387683e248d5de2
ms.sourcegitcommit: f240dc837aba42f4d579181297d0585d3dc0a35b
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/31/2021
ms.locfileid: "106011256"
---
...
| 0x110       | 中断服务例程的地址 | 在执行 ISR 之前保存的扩展上下文的地址 |扩展上下文的地址在执行 ISR 后保存|驱动程序 (ISR) 的中断服务例程已损坏扩展线程上下文。|
...
|0x1010 | 写入 IRP 所颁发到的设备对象。|IRP 的地址。|MDL 描述的缓冲区 System-Space 虚拟地址。|写入 Irp 的固定 MDL 缓冲区内容已修改。|
|0x1011 | 写入 IRP 所颁发到的设备对象。|IRP 的地址。|MDL 描述的缓冲区 System-Space 虚拟地址。|读取 Irp 的固定 MDL 缓冲区内容在调度或虚拟页面支持的缓冲区中被修改。|
