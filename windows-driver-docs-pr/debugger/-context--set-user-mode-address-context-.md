...
keywords:
- User-Mode 地址上下文 ( 设置) 命令
- 地址、设置 User-Mode 地址上下文 ( 上下文) 命令
- context，) 命令中设置 User-Mode 地址上下文 (
- " (在 Windows 调试) User-Mode 地址上下文设置上下文"
ms.date: 05/23/2017
topic_type:
- apiref
api_name:
...
ms.openlocfilehash: fcaf780ef21d849d61e76186408db3df4d735cb2
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96803345"
---
...
示例如下。 使用 [**！进程**](-process.md) 扩展查找所需进程的目录基：
