...
---
# <a name="bug-check-0x7e-system_thread_exception_not_handled"></a>Bug 检查 0x7E：SYSTEM @ NO__T-0THREAD @ NO__T-1EXCEPTION @ NO__T-2NOT @ NO__T-3HANDLED


SYSTEM @ no__t-0THREAD @ no__t-1EXCEPTION @ no__t-2NOT @ no__t-3HANDLED bug 检查的值为0x0000007E。 此 bug 检查指示系统线程生成了错误处理程序未捕获的异常。

> [!IMPORTANT]
> 本主题面向程序员。 如果你是在使用计算机时收到蓝屏错误代码的客户, 请参阅[排查蓝屏错误](https://www.windows.com/stopcode)。

## <a name="system_thread_exception_not_handled-parameters"></a>SYSTEM @ no__t-0THREAD @ no__t-1EXCEPTION @ no__t-2NOT @ no__t-3HANDLED 参数
...
SYSTEM @ no__t-0THREAD @ no__t-1EXCEPTION @ no__t-2NOT @ no__t-3HANDLED bug 检查指示系统线程生成了错误处理程序未捕获的异常。 若要对其进行解释，必须确定生成的异常。

常见的异常代码包括：

- 数0x80000002STATUS @ no__t-0DATATYPE @ no__t-1MISALIGNMENT 指示遇到了未对齐的数据引用。

- 0x80000003:STATUS @ no__t-0BREAKPOINT 指示在没有内核调试器附加到系统时遇到断点或断言。

- 0XC0000005STATUS @ no__t-0ACCESS @ no__t-1VIOLATION 指示发生了内存访问冲突。
...
如果打算调试此问题，参数2（异常地址）应标识导致此问题的驱动程序或函数。
