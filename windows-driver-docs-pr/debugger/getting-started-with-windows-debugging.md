...
本文档假设你了解 Windows 内部。 若要了解有关 Windows 内部机制的详细信息（包括内存使用情况、上下文、线程和进程），请查看其他资源，例如通过标记 Russinovich、David 所罗门群岛和 Alex Ionescu 的[*Windows 内部机制*](https://docs.microsoft.com/en-us/sysinternals/learn/windows-internals)。

## <a name="13-review-additional-debugging-resources"></a>13.查看其他调试资源

其他资源包括以下书籍和视频：
-  *在 Windows 调试中：Tarik Soulami 的实用调试*和跟踪策略
