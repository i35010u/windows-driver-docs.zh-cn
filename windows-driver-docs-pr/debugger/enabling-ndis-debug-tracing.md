...
你可以选择多个 NDIS 组件。 如果选择了多个组件，请将数据值与 OR 运算符组合。 例如，若要依次选择 "DBG"、"DBG"、"dbg"、"dbg" 和 "dbg"， \_ \_ 请将 \_ \_ \_ \_ \_ \_ 相应的值（0x1000、0x2000、0x1 和0x2）组合起来，以获取值0x3003，然后在注册表中对其进行设置：
