...
**注意**   大多数情况下，除非已加载私有符号，否则不能访问局部变量。 有关此情况的详细信息，请参阅 [dbgerr005：必需的私有符号](dbgerr005--private-symbols-required.md)。 若要显示局部变量的值，请使用 [**dv (在) 命令中显示局部变量**](dv--display-local-variables-.md) 。
