...
ms.locfileid: "56567862"
---
# <a name="create-user-mode-stack-trace-database"></a>创建用户模式堆栈跟踪数据库
...
**创建用户模式堆栈跟踪数据库**标志 （图像文件模式） 的特定进程或所有进程 （系统范围内） 的地址空间中创建一个运行时堆栈跟踪数据库。
