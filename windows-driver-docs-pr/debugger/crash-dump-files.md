...
description: 您可以使用 WinDbg 和其他 Windows 调试器分析故障转储文件。
...
您可以使用 WinDbg 和其他 Windows 调试器分析故障转储文件。

## <span id="ddk_crash_dump_files_dbg"></span><span id="DDK_CRASH_DUMP_FILES_DBG"></span>
> [!NOTE]
> 此内容适用于开发人员。 如果你是在使用计算机时收到蓝屏错误代码的客户，请参阅[排查蓝屏错误](https://go.microsoft.com/fwlink/p/?linkid=183646)。
...
[提取转储文件中的信息](extracting-information-from-a-dump-file.md)
