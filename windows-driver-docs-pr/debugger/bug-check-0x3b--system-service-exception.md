...
ms.locfileid: "71705406"
---
# <a name="bug-check-0x3b-system_service_exception"></a>Bug 检查 0x3B：SYSTEM @ NO__T-0SERVICE @ NO__T-1EXCEPTION


SYSTEM @ no__t-0SERVICE @ no__t-1EXCEPTION bug 检查的值为0x0000003B。 这表示执行从非特权代码转换为特权代码的例程时发生了异常。

> [!IMPORTANT]
> 本主题面向程序员。 如果你是在使用计算机时收到蓝屏错误代码的客户, 请参阅[排查蓝屏错误](https://www.windows.com/stopcode)。


## <a name="system_service_exception-parameters"></a>SYSTEM @ no__t-0SERVICE @ no__t-1EXCEPTION 参数
...
如果可以识别负责错误的驱动程序，则其名称将打印在蓝色屏幕上，并存储在内存中的位置（PUNICODE @ no__t-0STRING） **KiBugCheckDriver**。 你可以使用 "调试器[**dx （显示调试器对象模型表达式）** ](https://docs.microsoft.com/windows-hardware/drivers/debugger/dx--display-visualizer-variables-) " 命令来显示此 `dx KiBugCheckDriver`。
...
使用 @no__t 和来检查系统内存的一般状态。 @No__t （0）和 @no__t 1 命令也可用于检查内存的特定区域。 
