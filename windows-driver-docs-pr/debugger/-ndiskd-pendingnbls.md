...
ms.locfileid: "63335941"
---
# <a name="ndiskdpendingnbls"></a>!ndiskd.pendingnbls


**！ Ndiskd.pendingnbls**扩展插件都会显示挂起的功能的 Nbl ([**NET\_缓冲区\_列出**](https://msdn.microsoft.com/windows/hardware/drivers/network/net-buffer-list-structure)) 位于在传输过程中。
