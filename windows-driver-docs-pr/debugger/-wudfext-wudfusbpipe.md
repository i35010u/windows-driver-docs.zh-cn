...
description: Wudfext. wudfusbpipe 扩展显示有关 USB 管道对象的信息。
keywords:
...
ms.openlocfilehash: d7e87220a86b2f7089b894e15afabca1c2f1b62d
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96838379"
---
# <a name="wudfextwudfusbpipe"></a>!wudfext.wudfusbpipe


**！ Wudfext wudfusbpipe** 扩展显示有关 USB 管道对象的信息。
...
指定要显示其相关信息的 **IWDFUsbTargetPipe** 接口的地址。 [**！ Wudfext wudfobject**](-wudfext-wudfobject.md) extension 命令确定 **IWDFUsbTargetPipe** 的地址。
