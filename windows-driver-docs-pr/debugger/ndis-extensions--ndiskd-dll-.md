...
以下命令显示与网络适配器 WDF 类 Extension [NetAdapterCx](https://docs.microsoft.com/windows-hardware/drivers/netcx/)及其关联结构[NET_RING_BUFFER](https://docs.microsoft.com/windows-hardware/drivers/netcx/introduction-to-net-rings)和[NET_PACKET](https://docs.microsoft.com/windows-hardware/drivers/ddi/packet/ns-packet-_net_packet)相关的信息。
