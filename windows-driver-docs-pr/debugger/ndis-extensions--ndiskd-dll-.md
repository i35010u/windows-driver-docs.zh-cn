...
以下命令将显示与相关的信息[ **NET\_缓冲区\_列表**](https://msdn.microsoft.com/windows/hardware/drivers/network/net-buffer-list-structure)并[ **NET\_缓冲区**](https://msdn.microsoft.com/windows/hardware/drivers/network/net-buffer-structure)结构。
...
以下命令显示有关的信息[NDIS\_数据包](https://msdn.microsoft.com/library/windows/hardware/ff557086)结构。 这些扩展是旧的 NDIS 5.x 驱动程序。 NDIS\_数据包结构和其关联的体系结构已被弃用。
...
以下命令显示有关的信息[Connection-Oriented NDIS](https://msdn.microsoft.com/windows/hardware/drivers/network/connection-oriented-ndis)连接。
...
以下命令显示有关的信息[WDI 微型端口驱动程序](https://msdn.microsoft.com/windows/hardware/drivers/network/wdi-miniport-driver-design-guide)。
...
详细了解设计 NDIS 驱动程序适用于 Windows Vista 及更高版本，请参阅[网络驱动程序设计指南](https://msdn.microsoft.com/windows/hardware/drivers/network/index)。

有关适用于 Windows Vista 及更高版本的 NDIS 驱动程序的引用的详细信息，请参阅[Windows Vista 和更高版本的网络参考](https://msdn.microsoft.com/library/windows/hardware/ff571081)。
