...
ms.openlocfilehash: baeb732b257e05fc19e729b00298cab51d209465
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96830805"
---
...
- 检查中的系统日志事件查看器是否有其他错误消息，这些错误消息可能有助于找出导致错误的设备或驱动程序。 若要打开事件查看器选择键盘快捷方式 Win + R，键入 `eventvwr.msc` 并按 enter 键。 在系统日志中查找与蓝屏同时出现的严重错误。
