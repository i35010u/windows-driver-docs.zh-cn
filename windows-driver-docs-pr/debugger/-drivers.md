...
如果设置了此位并且未设置位 2 (0x4), 则显示内容将包含有关驻留、备用和锁定内存以及加载程序条目地址的信息。 如果设置了 "位 2", 则会导致显示的驱动程序映像的更长、更详细的列表。 包含有关标头的信息, 如节信息所述。

<span id="Bit_2__0x4_"></span><span id="bit_2__0x4_"></span><span id="BIT_2__0X4_"></span>位 2 (0x4)  
使显示成为驱动程序映像的更长和更详细的列表。 包括有关每个部分的信息。 如果设置了位 1 (0x2), 这还将包括标头信息。
