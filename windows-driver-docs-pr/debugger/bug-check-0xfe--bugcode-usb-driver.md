...
USB 客户端驱动程序已提交仍附加到挂起的总线驱动程序中的另一个 IRP URB。
...
USB 微型端口驱动程序已生成的 bug 检查。 这通常发生硬件故障的响应中。
...
PDO 如果参数 3 不为 NULL。 如果参数 3 为 NULL 的上下文。
