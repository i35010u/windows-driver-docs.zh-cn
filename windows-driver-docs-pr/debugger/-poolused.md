...
ms.openlocfilehash: f203c286ed8218300ee7b0919321a436b539a038
ms.sourcegitcommit: 418e6617e2a695c9cb4b37b5b60e264760858acd
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2020
ms.locfileid: "96788925"
---
...
## <a name="span-idddk__poolused_dbgspanspan-idddk__poolused_dbgspanparameters"></a><span id="ddk__poolused_dbg"></span><span id="DDK__POOLUSED_DBG"></span>参数


<span id="_______Flags______"></span><span id="_______flags______"></span><span id="_______FLAGS______"></span>*标志*   
指定要显示的输出量和输出的排序方法。 这可以是以下位值的任意组合，但第1个 (0x2) ，2 (0x4) 不能一起使用。 默认值为0x0，这会生成摘要信息，按池标记排序。
...
<span id="Bit_3__0x8_"></span><span id="bit_3__0x8_"></span><span id="BIT_3__0X8_"></span>第 3 (0x8)   
 (Windows Server 2003 和更高版本) 显示会话池，而不是标准池。

**注意**  可以使用 [**！！ session**](-session.md) 命令在会话之间切换。
