...
若要设置或清除特定池功能 (Windows Vista 和更高版本) 
...
<p>如果未指定图像文件，则 Windows 将跟踪具有指定池标记的所有对象。 如果同时指定了图像文件 (<strong>/i</strong>) 和一个或多个池标记 (<strong>/t</strong>) ，则 Windows 将跟踪具有指定映像创建的任何指定池标记的对象。</p></td>
</tr>
<tr class="odd">
