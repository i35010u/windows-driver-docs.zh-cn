...
ms.locfileid: "56545904"
---
# <a name="triaging-wdtf-based-tests"></a>会审 WDTF 基于测试


若要帮助您更好地了解这怎么回事 WDTF 基于测试中，可以使用的内置支持[WDTF 对象日志记录](logging-and-tracing.md)并[WPP 软件跟踪](https://msdn.microsoft.com/library/windows/hardware/ff556204)。
