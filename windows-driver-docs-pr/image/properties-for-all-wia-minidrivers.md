...
### <a name="required-properties-on-root-or-child-items"></a>根或子项的所需的属性
...
### <a name="required-properties-on-root-items"></a>对根项所需的属性
...
[**WIA\_DIP\_端口\_名称**](https://msdn.microsoft.com/library/windows/hardware/ff550278)

[**WIA\_DIP\_远程\_开发人员\_ID**](https://msdn.microsoft.com/library/windows/hardware/ff550282)

[**WIA\_DIP\_SERVER\_NAME**](https://msdn.microsoft.com/library/windows/hardware/ff550285)

[**WIA\_DIP\_STI\_常规\_功能**](https://msdn.microsoft.com/library/windows/hardware/ff550288)
...
### <a name="optional-properties-on-root-items"></a>对根项的可选属性

WIA 微型驱动程序提供根项上的以下可选属性：

[**WIA\_DPA\_CONNECT\_状态**](https://msdn.microsoft.com/library/windows/hardware/ff550299)
...
### <a name="required-properties-on-child-items-able-to-transfer-data"></a>能够将数据传输的子项目上的所需的属性

WIA 服务提供的子项目上的以下属性：

[**WIA\_IPA\_ICM\_PROFILE\_NAME**](https://msdn.microsoft.com/library/windows/hardware/ff551571)

WIA 微型驱动程序提供的子项目上的以下属性：
...
[**WIA\_IPA\_数\_OF\_行**](https://msdn.microsoft.com/library/windows/hardware/ff551611)
...
### <a name="optional-properties-on-child-items-able-to-transfer-data"></a>能够将数据传输的子项目的可选属性

WIA 微型驱动程序提供以下属性：

[**WIA\_IPA\_应用程序\_颜色\_映射**](https://msdn.microsoft.com/library/windows/hardware/ff551521)
...
[**WIA\_IPA\_区域\_类型**](https://msdn.microsoft.com/library/windows/hardware/ff551646)
