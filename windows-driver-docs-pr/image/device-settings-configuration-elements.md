---
title: 设备设置配置元素
description: 设备设置配置元素
ms.assetid: 1393f384-b688-48af-86d7-9a422a1e3cc6
ms.date: 11/28/2017
ms.localizationpriority: medium
ms.openlocfilehash: 586f8b20455da9cf88059dc94c3dbb68f5d5163f
ms.sourcegitcommit: 0cc5051945559a242d941a6f2799d161d8eba2a7
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2019
ms.locfileid: "63364553"
---
# <a name="device-settings-configuration-elements"></a>设备设置配置元素


本部分介绍 Web Services for Devices (WSD) 扫描服务架构的设备设置的元素。 设备设置描述扫描设备的基本功能。
