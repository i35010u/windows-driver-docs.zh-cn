...
ms.locfileid: "56526426"
---
# <a name="wia-driver-versioning"></a>WIA 驱动程序版本控制


驱动程序报告的版本 WIA （或 STI 旧驱动程序），它支持从返回的版本字段[ **IStiUSD::GetCapabilities**](https://msdn.microsoft.com/library/windows/hardware/ff543817)。 驱动程序通常将此字段设置为 STI\_版本中定义*Sti.h*。
