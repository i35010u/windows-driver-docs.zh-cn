---
title: MinValue 元素
description: 所需的 MinValue 元素指定扫描设备支持需要的值范围的扫描程序配置元素的最小值。
...
ms.locfileid: "56576518"
---
# <a name="minvalue-element"></a>MinValue 元素


所需**MinValue**元素指定扫描设备支持需要的值范围的扫描程序配置元素的最小值。
...
值**MinValue**元素取决于其父元素。 有关可能的值，请参阅合适的父元素。
