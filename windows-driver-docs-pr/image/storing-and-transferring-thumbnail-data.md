...
由三个 WIA 属性控制 WIA 缩略图的信息：[**WIA\_IPC\_缩略图**](https://msdn.microsoft.com/library/windows/hardware/ff552550)， [ **WIA\_IPC\_缩略图\_宽度**](https://msdn.microsoft.com/library/windows/hardware/ff552558)，和[ **WIA\_IPC\_缩略图\_高度**](https://msdn.microsoft.com/library/windows/hardware/ff552552)。 在 Windows Me，并在 Windows XP 及更高版本，缩略图的数据是 24 位每像素只有。
