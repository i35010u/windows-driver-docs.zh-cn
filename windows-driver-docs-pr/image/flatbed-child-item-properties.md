...
ms.locfileid: "56520942"
---
# <a name="flatbed-child-item-properties"></a>平板子项目属性
...
**请注意**   [ **WIA\_IPA\_项\_类别**](https://msdn.microsoft.com/library/windows/hardware/ff551581)属性必须设置为 WIA\_类别\_平板平板项目和平板子项目。

 

子项目可以选择性地支持除受父项的任何其他属性[ **WIA\_IPS\_支持\_子\_项\_创建** ](https://msdn.microsoft.com/library/windows/hardware/ff552653)并[ **WIA\_IP\_分段**](https://msdn.microsoft.com/library/windows/hardware/ff552649)属性。
