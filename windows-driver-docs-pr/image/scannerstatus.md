---
title: ScannerStatus 元素
description: 所需的 ScannerStatus 元素包含与扫描程序相关的信息的当前状态自动机时 （例如时间以及更改扫描程序中的条件） 控制。
ms.assetid: 39a1bbc1-acee-4ac8-8b14-35a3be5076ae
keywords:
- ScannerStatus 元素成像设备
topic_type:
- apiref
api_name:
- wscn ScannerStatus
...
ms.locfileid: "56526821"
---
# <a name="scannerstatus-element"></a>ScannerStatus 元素


所需**ScannerStatus**元素包含与扫描程序相关的信息的当前状态自动机时 （例如时间以及更改扫描程序中的条件） 控制。
