...
<a href="" id="wia-ips-xpos--wia-ips-ypos"></a>[**WIA\_IPS\_XPOS**](https://msdn.microsoft.com/library/windows/hardware/ff552663)， [ **WIA\_IP\_YPOS**](https://msdn.microsoft.com/library/windows/hardware/ff552671)  
这些属性设置相同的 RAW 相同，均为其他图像格式。 这些属性包含以像素为单位的所选图像的左上角的坐标

<a href="" id="wia-ips-xres--wia-ips-yres"></a>[**WIA\_IPS\_XRES**](https://msdn.microsoft.com/library/windows/hardware/ff552665)， [ **WIA\_IP\_YRES**](https://msdn.microsoft.com/library/windows/hardware/ff552673)  
这些属性设置相同的 RAW 相同，均为其他图像格式。 这些属性 （分别） 包含当前水平和垂直分辨率，以像素为单位的每英寸点数，设备

<a href="" id="wia-ips-xextent--wia-ips-yextent"></a>[**WIA\_IPS\_大 XEXTENT**](https://msdn.microsoft.com/library/windows/hardware/ff552661)， [ **WIA\_IP\_YEXTENT**](https://msdn.microsoft.com/library/windows/hardware/ff552669)  
...
此属性包含的每个像素的位数。 驱动程序应用程序集时设置此属性的值[ **WIA\_IPA\_格式**](https://msdn.microsoft.com/library/windows/hardware/ff551553)到**WiaImgFmt\_RAW**。 所有 WIA 中的项的总和\_IPA\_RAW\_BITS\_每\_通道属性必须等于 WIA 中存储的号\_IPA\_DEPTH 属性。 WIA\_IPA\_深度是可写，如果该驱动程序支持多个配置。 例如，对于支持 32 位 / 像素和 48 位 / 像素配置驱动程序，该应用程序可以选择一种设置，并且该驱动程序应设置 WIA\_IPA\_RAW\_BITS\_每\_通道和关联的属性相应地。

<a href="" id="wia-ipa-raw-bits-per-channel"></a>[**WIA\_IPA\_RAW\_BITS\_每\_通道**](https://msdn.microsoft.com/library/windows/hardware/ff551641)  
