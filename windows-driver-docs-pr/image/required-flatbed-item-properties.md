...
ms.locfileid: "56555779"
---
# <a name="required-flatbed-item-properties"></a>所需的平板项属性
...
**请注意**   [ **WIA\_IPA\_RAW\_位\_每\_通道**](https://msdn.microsoft.com/library/windows/hardware/ff551641)属性是必需的如果WiaImgFmt\_支持原始格式。 [ **WIA\_IPA\_格式**](https://msdn.microsoft.com/library/windows/hardware/ff551553)属性必须支持 WiaImgFmt\_BMP 格式。 [ **WIA\_IPS\_阈值**](https://msdn.microsoft.com/library/windows/hardware/ff552655)时，属性是必需[ **WIA\_IPA\_深度**](https://msdn.microsoft.com/library/windows/hardware/ff551546)属性设置为 1 位 / 像素 (BPP) 时，或者当[ **WIA\_IPA\_数据类型**](https://msdn.microsoft.com/library/windows/hardware/ff551543)属性设置为 WIA\_数据\_阈值。
