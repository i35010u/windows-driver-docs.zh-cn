...
description: WDI_TLV_FTM_TARGET_BSS_ENTRY 是一个 TLV，其中包含用于精确计时度量（INTERNAL.H）过程的 BSS 目标的信息。
ms.assetid: 04C996C7-8207-4363-A990-5CF39B0333F8
ms.date: 02/13/2019
keywords:
- WDI_TLV_FTM_TARGET_BSS_ENTRY 从 Windows Vista 开始的网络驱动程序
...
ms.locfileid: "72844983"
---
# <a name="wdi_tlv_ftm_target_bss_entry"></a>WDI_TLV_FTM_TARGET_BSS_ENTRY

**WDI_TLV_FTM_TARGET_BSS_ENTRY**是一个 TLV，其中包含用于精确计时度量（internal.h）过程的 BSS 目标的信息。 
...
| [WDI_TLV_REQUEST_LCI_REPORT](wdi-tlv-request-lci-report.md) | UINT8 |   |   | 可能值： <ul><li>0：不需要 LCI 报表。</li><li>1：应请求 LCI 报告。</li></ul> |
