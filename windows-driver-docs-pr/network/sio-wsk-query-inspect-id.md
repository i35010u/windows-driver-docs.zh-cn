...
若要查询的面向连接的套接字检查验证数据，WSK 应用程序调用[ **WskControlSocket** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wsk/nc-wsk-pfn_wsk_control_socket)使用以下参数的函数。
...
有关有条件地接受连接的详细信息，请参阅[用于侦听和接受传入连接](https://docs.microsoft.com/windows-hardware/drivers/network/listening-for-and-accepting-incoming-connections)。
