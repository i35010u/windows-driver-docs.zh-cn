...
description: WDI_TLV_FT_INITIAL_ASSOC_PARAMETERS 是快速转换为包含初始关联参数 TLV。
...
ms.locfileid: "63329653"
---
# <a name="wditlvftinitialassocparameters"></a>WDI\_TLV\_FT\_初始\_ASSOC\_参数


WDI\_TLV\_FT\_初始\_ASSOC\_参数是快速转换为包含初始关联参数 TLV。
