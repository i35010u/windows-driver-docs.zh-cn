...
ms.locfileid: "63380553"
---
# <a name="wditlvgetautopowersave"></a>WDI\_TLV\_GET\_AUTO\_POWER\_SAVE


WDI\_TLV\_获取\_自动\_POWER\_另存为包含的信息的自动节能 TLV [OID\_WDI\_获取\_自动\_POWER\_保存](https://msdn.microsoft.com/library/windows/hardware/dn925840)。
...
| [**WDI\_POWER\_SAVE\_LEVEL**](https://msdn.microsoft.com/library/windows/hardware/dn926107) (UINT32)              | 电源模式。                                                                                                    |
| [**WDI\_POWER\_SAVE\_LEVEL**](https://msdn.microsoft.com/library/windows/hardware/dn926107) (UINT32)              | Dx 中的电源模式。                                                                                              |
| [**WDI\_电源\_模式\_原因\_代码**](https://msdn.microsoft.com/library/windows/hardware/dn926106) (UINT32) | 进入节能状态和侦听间隔的原因。                                                  |
| UINT64                                                                             | 自启动以来的毫秒数。                                                                                          |
| UINT64                                                                             | 保存模式电源中的毫秒数。                                                                                   |
