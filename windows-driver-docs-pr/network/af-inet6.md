...
使用指定的 IPv6 传输地址[ **SOCKADDR\_IN6** ](https://msdn.microsoft.com/library/windows/hardware/ff570824)结构。
...
IPv6 支持以下的套接字类型和协议组合的每个 WSK[套接字类别](https://msdn.microsoft.com/library/windows/hardware/ff571093):
