...
ms.date: 08/08/2017
keywords: -从 Windows Vista 开始 OID_NIC_SWITCH_VPORT_PARAMETERS 网络驱动程序
...
成功从 OID 方法请求返回后， [**ndis\_OID\_请求**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_oid_request)结构的**InformationBuffer**成员包含指向[**ndis\_NIC 的指针\_SWITCH\_VPORT\_参数**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_nic_switch_vport_parameters)结构。 此结构包含指定开关的配置参数。
...
2.  相应的 NDIS\_NIC\_交换机\_VPORT\_参数\_*Xxx*\_更改标志在**flags**成员中设置。 仅当相应的*ndis\_nic*\_\_参数结构时，才可以更改[**NDIS\_nic\_交换机\_VPORT 参数**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_nic_switch_vport_parameters)结构在 Ntddndis 中定义。
...
在 PF 微型端口驱动程序接收 OID\_NIC\_开关\_VPORT\_参数后，该驱动程序将用配置参数配置硬件。 驱动程序只能更改由 NDIS\_NIC 标识的配置参数，\_交换机\_VPORT\_参数\_*Xxx*\_\_Nic 的**FLAGS**成员中更改的标志 @no__t [ **_11_ 开关\_VPORT\_参数**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_nic_switch_vport_parameters)结构。
...
<td><p>信息缓冲区太短。 NDIS 或 PF 微型端口驱动程序设置<strong>数据。METHOD_INFORMATION.BytesNeeded</strong>成员（用于 OID 方法请求）或<strong>数据。SET_INFORMATION.</strong> <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_oid_request" data-raw-source="[&lt;strong&gt;NDIS_OID_REQUEST&lt;/strong&gt;](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_oid_request)"><strong>NDIS_OID_REQUEST</strong></a>结构中的 BytesNeeded 成员（用于 OID 设置的请求）是所需的最小缓冲区大小。</p></td>
</tr>
<tr class="odd">
