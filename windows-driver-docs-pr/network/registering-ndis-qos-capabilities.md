...
1.  微型端口驱动程序初始化**标头**成员。 驱动程序将**标头**的**类型**成员设置为\_对象\_类型\_QOS\_功能。
    ...
    从 NDIS 6.30 开始，微型端口驱动程序会将**标头**的**修订**成员设置为 NDIS\_QOS\_功能\_修订版本\_1，将**大小**成员设置为 ndis\_\_\_\_\_
...
3.  如果网络适配器支持绕过媒体访问控制安全性（MACsec）处理的功能，微型端口驱动程序会将 NDIS\_QOS\_功能\_\_绕过**Flags**成员中受支持的\_标志。 有关 MACsec 的详细信息，请参阅 IEEE 802.1 AE-2006 标准。
