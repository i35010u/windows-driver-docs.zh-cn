...
[注册到 WMI 的标准的微型端口驱动程序 Oid](standard-miniport-driver-oids-registered-with-wmi.md)

[标准的微型端口驱动程序状态指示已向 WMI 注册](standard-miniport-driver-status-indications-registered-with-wmi.md)
