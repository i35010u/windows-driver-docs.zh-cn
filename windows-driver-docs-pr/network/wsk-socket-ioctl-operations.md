---
title: WSK 套接字 IOCTL 操作
description: WSK 子系统支持用以下套接字 I/O 控制操作
ms.assetid: ffdf74d4-4795-4d3f-aaf0-49db89f5ad93
ms.date: 07/18/2017
keywords:
- 网络、 WSK WDK IOCTL 操作
- 网络、 Winsock 内核 WDK IOCTL 操作
- WSK WDK 网络、 操作
...
-   [**SIO\_WSK\_查询\_检查\_ID**](sio-wsk-query-inspect-id.md)
-   [**SIO\_WSK\_查询\_接收\_积压工作**](sio-wsk-query-receive-backlog.md)
