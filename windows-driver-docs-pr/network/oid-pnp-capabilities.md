...
指定从其微型端口驱动程序的网络适配器可以指示在接收幻数据包唤醒的最低设备电源状态。 (A*幻数据包*是包含 16 个连续副本接收的网络适配器的以太网地址的数据包。)设备电源状态指定为以下值之一[ **NDIS\_设备\_POWER\_状态**](https://msdn.microsoft.com/library/windows/hardware/gg602135)值：
...
指定从其微型端口驱动程序的网络适配器可以发出信号收到包含通过协议驱动程序指定的模式的网络帧上的唤醒事件的最低设备电源状态。 电源状态指定为以下值之一[ **NDIS\_设备\_POWER\_状态**](https://msdn.microsoft.com/library/windows/hardware/gg602135)值：
...
如果微型端口驱动程序的网络适配器不支持特定唤醒事件，微型端口驱动程序应指示[ **NDIS\_设备\_POWER\_状态**](https://msdn.microsoft.com/library/windows/hardware/gg602135)的值**NdisDeviceStateUnspecified**中的唤醒事件**NDIS\_PM\_唤醒\_向上\_功能**结构。
...
**请注意**  NDIS 6.20 和更高版本的微型端口驱动程序报告电源管理功能的方式的信息，请参阅[报告电源管理功能](https://msdn.microsoft.com/library/windows/hardware/ff570672)。
...
[报告电源管理功能](https://msdn.microsoft.com/library/windows/hardware/ff570672)
