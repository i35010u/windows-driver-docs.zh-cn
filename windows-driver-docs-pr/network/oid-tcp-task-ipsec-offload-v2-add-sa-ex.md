...
ms.openlocfilehash: 9a70f34e87382000bf04afd277dc3f06f97aeabb
ms.sourcegitcommit: fb7d95c7a5d47860918cd3602efdd33b69dcf2da
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/25/2019
ms.locfileid: "67353718"
---
...
微型端口驱动程序配置的 NIC IPsecOV2 对该 SAs 的处理。 成功设置为 OID\_TCP\_任务\_IPSEC\_卸载\_V2\_添加\_SA\_EX、 微型端口驱动程序提供标识的句柄卸载中的 SA **OffloadHandle**的成员[ **IPSEC\_卸载\_V2\_添加\_SA\_EX**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/ns-ndis-_ipsec_offload_v2_add_sa_ex)结构。 （例如，传输使用句柄发送路径中以指示其卸载 SA 使用）。 如果已卸载的 SA，集请求是成功的。
...
此 OID 是以前版本中，实质上是相同[OID\_TCP\_任务\_IPSEC\_卸载\_V2\_添加\_SA](oid-tcp-task-ipsec-offload-v2-add-sa.md)。 唯一的区别是更新后[ **IPSEC\_卸载\_V2\_添加\_SA\_EX** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/ns-ndis-_ipsec_offload_v2_add_sa_ex)结构。
