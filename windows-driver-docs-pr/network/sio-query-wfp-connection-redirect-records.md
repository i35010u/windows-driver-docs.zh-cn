...
ms.date: 08/08/2017
keywords: -SIO_QUERY_WFP_CONNECTION_REDIRECT_RECORDS 控制从 Windows Vista 开始的代码网络驱动程序
...
**请注意**  **SIO\_query\_WFP\_连接\_重定向\_** 仅当连接在**FWPS\_层重定向\_ALE\_连接时才能使用\_重定向\_V4**或**FWPS\_层\_ALE\_将\_\_重定向到**WFP 客户端。
