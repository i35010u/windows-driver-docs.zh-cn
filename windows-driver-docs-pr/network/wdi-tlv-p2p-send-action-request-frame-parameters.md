...
ms.locfileid: "56575766"
---
# <a name="wditlvp2psendactionrequestframeparameters"></a>WDI\_TLV\_P2P\_SEND\_ACTION\_REQUEST\_FRAME\_PARAMETERS


WDI\_TLV\_P2P\_发送\_操作\_请求\_帧\_参数是包含参数用于发送与Wi-FiDirect操作请求帧TLV[OID\_WDI\_任务\_P2P\_发送\_请求\_操作\_帧](https://msdn.microsoft.com/library/windows/hardware/dn925956)。
...
| 在任务栏的搜索框中键入                                                                    | 描述                                                                                                                    |
|-------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| [**WDI\_P2P\_ACTION\_FRAME\_TYPE**](https://msdn.microsoft.com/library/windows/hardware/dn926086) | 要发送的请求类型。                                                                                                   |
| [**WDI\_MAC\_ADDRESS**](https://msdn.microsoft.com/library/windows/hardware/dn926071)                       | 目标对等设备的 MAC 地址。                                                                                     |
| UINT8                                                                   | 直接对话框中的标记的事务。                                                                                   |
