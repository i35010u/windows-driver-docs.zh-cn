...
本主题概述了网络筛选器驱动程序的 INF 文件要求。 NDIS 6.0 和更高版本中支持筛选器驱动程序。 有关如何安装筛选器驱动程序的详细信息，请参阅[NDIS 筛选器驱动程序安装](ndis-filter-driver-installation.md)。
...
<p>设置 NCF_LW_FILTER （而 0x40000 可）。 筛选器驱动程序不设置 NCF_FILTER (0x400) 标志。 值 NCF_<em>Xxx</em> Netcfgx.h 中定义的标志。 详细了解 NCF_<em>Xxx</em>标记，请参阅<a href="ddinstall-section-in-a-network-inf-file.md" data-raw-source="[DDInstall Section in a Network INF File](ddinstall-section-in-a-network-inf-file.md)">DDInstall 网络 INF 文件中的部分</a>。</p>
...
<p><strong>ServiceBinary</strong>中的条目<strong>服务安装</strong>INF 文件的部分指定的筛选器驱动程序二进制文件的路径。</p>
<p>设置<strong>FilterType</strong>并<strong>FilterRunType</strong> 。 请参阅<a href="types-of-filter-drivers.md" data-raw-source="[Types of Filter Drivers](types-of-filter-drivers.md)">类型的筛选器驱动程序</a>。</p>
<p>设置<strong>UpperRange</strong>， <strong>LowerRange</strong>，并<strong>FilterMediaTypes</strong>条目。 请参阅<a href="specifying-filter-driver-binding-relationships.md" data-raw-source="[Specifying Filter Driver Binding Relationships](specifying-filter-driver-binding-relationships.md)">指定筛选器驱动程序绑定关系</a>。</p>
<p>指定的筛选器的主服务名称<strong>CoServices</strong>属性。</p>
<p>指定<strong>FilterClass</strong>以确定在一摞修改筛选器顺序。 请参阅<a href="configuring-an-inf-file-for-a-modifying-filter-driver.md" data-raw-source="[Configuring an INF File for a Modifying Filter Driver](configuring-an-inf-file-for-a-modifying-filter-driver.md)">配置修改的筛选器驱动程序 INF 文件</a>。</p>
<p>另请参阅<a href="configuring-an-inf-file-for-a-monitoring-filter-driver.md" data-raw-source="[Configuring an INF File for a Monitoring Filter Driver](configuring-an-inf-file-for-a-monitoring-filter-driver.md)">配置用于监视的筛选器驱动程序的 INF 文件</a>，<a href="adding-service-related-values-to-the-ndi-key.md" data-raw-source="[Adding Service-Related Values to the Ndi Key](adding-service-related-values-to-the-ndi-key.md)">将与服务相关的值添加到 Ndi 键</a>，并<a href="ddinstall-services-section-in-a-network-inf-file.md" data-raw-source="[DDInstall.Services Section in a Network INF File](ddinstall-services-section-in-a-network-inf-file.md)">DDInstall.Services 网络 INF 文件中的部分</a>.</p></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p>可选</p></td>
