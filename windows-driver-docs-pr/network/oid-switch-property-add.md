...
转发扩展可以处理 OID 集请求的 OID\_交换机\_属性\_添加。 所有其他类型的扩展必须调用[ **NdisFOidRequest** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndisfoidrequest) OID 请求转发到可扩展交换机驱动程序堆栈中的下一个扩展。
...
有关如何处理 OID 的指导原则设置请求的 OID\_交换机\_属性\_添加，请参阅[管理交换机策略](https://docs.microsoft.com/windows-hardware/drivers/network/managing-switch-policies)。
