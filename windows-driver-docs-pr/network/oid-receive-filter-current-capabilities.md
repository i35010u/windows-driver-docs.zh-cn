...
1.  该驱动程序初始化[ **NDIS\_接收\_筛选器\_功能**](https://msdn.microsoft.com/library/windows/hardware/ff566864)具有当前已启用结构接收硬件的筛选功能。
...
-   NDIS 提供当前已启用接收到过量协议中的驱动程序的筛选功能的基础的网络适配器**ReceiveFilterCapabilities**的成员[ **NDIS\_绑定\_参数**](https://msdn.microsoft.com/library/windows/hardware/ff564832)绑定操作过程中的结构。

-   NDIS 提供当前已启用接收到过量中的筛选器驱动程序的筛选功能的基础的网络适配器**ReceiveFilterCapabilities**的成员[ **NDIS\_筛选器\_附加\_参数**](https://msdn.microsoft.com/library/windows/hardware/ff565481)在附加操作期间的结构。
