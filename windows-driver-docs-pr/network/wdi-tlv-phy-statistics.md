...
ms.locfileid: "67380753"
---
# <a name="wditlvphystatistics"></a>WDI\_TLV\_PHY\_统计信息


WDI\_TLV\_PHY\_统计信息是包含每个物理统计信息的 TLV [OID\_WDI\_获取\_统计信息](https://docs.microsoft.com/windows-hardware/drivers/network/oid-wdi-get-statistics)。
