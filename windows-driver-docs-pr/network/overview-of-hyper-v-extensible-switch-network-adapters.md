---
title: HYPER-V 可扩展交换机的网络适配器的概述
description: HYPER-V 可扩展交换机的网络适配器的概述
...
ms.locfileid: "56521232"
---
# <a name="overview-of-hyper-v-extensible-switch-network-adapters"></a>HYPER-V 可扩展交换机的网络适配器的概述
