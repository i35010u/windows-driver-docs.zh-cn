...
**请注意**  在发送路径封装数据包，如果[ **NDIS\_TCP\_发送\_将卸载\_补充\_NET\_缓冲区\_列表\_信息**](https://msdn.microsoft.com/library/windows/hardware/jj991957)。**IsEncapsulatedPacket**是**TRUE**。
...
-   GRE ([RFC 2784:通用路由封装 (GRE)](http://tools.ietf.org/html/rfc2784)) 标头
-   [RFC 2890:键和序列号 GRE 扩展](http://tools.ietf.org/html/rfc2890)
-   IPv4 ([RFC 791:Internet 协议](http://tools.ietf.org/html/rfc791)) 标头
-   IPv6 ([RFC 2460:Internet 协议版本 6 (IPv6)](http://tools.ietf.org/html/rfc2460)) 标头
