...
ms.locfileid: "67362807"
---
# <a name="wditlvsetencapsulationoffloadv4parameters"></a>WDI\_TLV\_SET\_ENCAPSULATION\_OFFLOAD\_V4\_PARAMETERS


WDI\_TLV\_设置\_封装\_卸载\_V4\_参数是由 TLV [OID\_WDI\_设置\_封装\_卸载](https://docs.microsoft.com/windows-hardware/drivers/network/oid-wdi-set-encapsulation-offload)以指示是否应启动 IPv4 卸载。
