...
description: WDI_TLV_CHECKSUM_OFFLOAD_V6_RX_PARAMETERS 是包含校验和卸载对 IPv6 的 rx TLV。
...
ms.locfileid: "56577080"
---
# <a name="wditlvchecksumoffloadv6rxparameters-0xdd"></a>WDI\_TLV\_CHECKSUM\_卸载\_V6\_RX\_参数 (0xDD)


WDI\_TLV\_CHECKSUM\_卸载\_V6\_RX\_参数是包含用于对 IPv6 的 Rx 校验和卸载 TLV。
