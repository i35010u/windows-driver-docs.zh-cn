...
> [!NOTE]
> 驱动程序可以通过调用查询的 NDIS 版本 [**NdisReadConfiguration**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisreadconfiguration) 函数与 *关键字* 参数设置为 **NdisVersion**. 
