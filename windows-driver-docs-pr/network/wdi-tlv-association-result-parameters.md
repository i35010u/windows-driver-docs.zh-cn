...
| 在任务栏的搜索框中键入                                                        | 描述                                                                                                                                                                                                                                         |
|-------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| UINT32                                                      | 指定关联尝试的完成状态，如中所定义[ **WDI\_ASSOC\_状态**](https://msdn.microsoft.com/library/windows/hardware/dn897725)。                                                                                                                       |
| UINT32                                                      | 对等方的身份验证或关联请求响应来自此端口发送的 802.11 状态代码。                                                                                                                                     |
| UINT8                                                       | 指定是否端口发送的 802.11 的关联或 802.11 重新关联请求到 AP。 如果使用重新关联请求，此值应设置为 1。                                                                              |
| [**WDI\_身份验证\_算法**](https://msdn.microsoft.com/library/windows/hardware/dn897792)     | 该端口关联期间与对等方协商身份验证算法。                                                                                                                                                             |
| [**WDI\_密码\_算法**](https://msdn.microsoft.com/library/windows/hardware/dn897802) | 该端口关联期间与对等方协商单播密码算法。                                                                                                                                                             |
| [**WDI\_密码\_算法**](https://msdn.microsoft.com/library/windows/hardware/dn897802) | 多路广播的数据加密算法，它与对等方协商期间关联端口。                                                                                                                                                      |
| [**WDI\_密码\_算法**](https://msdn.microsoft.com/library/windows/hardware/dn897802) | 该端口关联期间与对等方协商多播的管理密码算法。                                                                                                                                                |
...
| [**WDI\_DS\_INFO**](https://msdn.microsoft.com/library/windows/hardware/dn897813)                   | 指定该端口连接到同一个 DS 为其以前的关联。                                                                                                                                                                 |
