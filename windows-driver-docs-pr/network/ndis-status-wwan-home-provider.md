...
-   基于 CDMA 的设备：返回 home 提供程序名称是必需的。 建议 Ihv 在其设备中将此信息作为网络个性化的一部分提供。 如果提供程序标识不可用，则基于 CDMA 的提供程序的微型端口驱动程序必须将 NDIS\_HOME\_提供程序结构的\_**NDIS 成员设置**为 WWAN\_CDMA\_默认值\_提供程序\_ID。
