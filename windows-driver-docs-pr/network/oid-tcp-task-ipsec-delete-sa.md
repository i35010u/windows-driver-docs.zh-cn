...
ms.locfileid: "85918289"
---
# <a name="oid_tcp_task_ipsec_delete_sa"></a>OID_TCP_TASK_IPSEC_DELETE_SA

OID_TCP_TASK_IPSEC_DELETE_SA OID 由传输协议设置，以请求微型端口驱动程序从 NIC 中删除安全关联（SA）。 SA 信息的格式设置为[OFFLOAD_IPSEC_DELETE_SA](https://docs.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_offload_ipsec_delete_sa)结构。
