---
title: 处理的 CoNDIS 协议驱动程序中的状态指示
description: 处理的 CoNDIS 协议驱动程序中的状态指示
...
ms.locfileid: "56524163"
---
# <a name="handling-status-indications-in-a-condis-protocol-driver"></a>处理的 CoNDIS 协议驱动程序中的状态指示
