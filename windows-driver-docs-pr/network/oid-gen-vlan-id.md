...
微型端口驱动程序的过程[ *MiniportInitializeEx* ](https://msdn.microsoft.com/library/windows/hardware/ff559389)函数特定的 NIC，驱动程序的最初设置为零的 NIC 的 VLAN ID。 在驱动程序*MiniportInitializeEx*函数然后读取以下配置参数从注册表中，并，如果存在，参数，则 NIC 的 VLAN ID 设置为参数的值。
