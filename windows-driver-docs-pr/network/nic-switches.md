...
-   动态创建基于对象标识符 (OID) 的方法请求[OID\_NIC\_交换机\_创建\_开关](https://docs.microsoft.com/windows-hardware/drivers/network/oid-nic-switch-create-switch)。 NDIS 或 HYPER-V 可扩展交换机模块发出这些 OID 请求 SR-IOV 网络适配器上创建 NIC 开关。
