...
ms.openlocfilehash: c52bafb79fd7513be98dcb085c1353ab810d7b9e
ms.sourcegitcommit: f500ea2fbfd3e849eb82ee67d011443bff3e2b4c
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/31/2020
ms.locfileid: "89210121"
---
...
有关如何还原运行时数据的详细信息，请参阅 [还原 Hyper-v 可扩展交换机运行时数据](./managing-hyper-v-extensible-switch-run-time-data.md)。
