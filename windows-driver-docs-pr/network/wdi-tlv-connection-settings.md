...
ms.locfileid: "67384525"
---
# <a name="wditlvconnectionsettings"></a>WDI\_TLV\_连接\_设置


WDI\_TLV\_连接\_设置为包含的连接设置 TLV [OID\_WDI\_任务\_CONNECT](https://docs.microsoft.com/windows-hardware/drivers/network/oid-wdi-task-connect)。
...
| [**WDI\_ASSOC\_状态**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wditypes/ne-wditypes-_wdi_assoc_status) (UINT32) | 指定所需的漫游原因。 如果这由于触发[NDIS\_状态\_WDI\_指示\_漫游\_需执行](https://docs.microsoft.com/windows-hardware/drivers/network/ndis-status-wdi-indication-roaming-needed)，其中包含从漫游指示的原因。 |
| [**WDI\_ROAM\_TRIGGER**](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wditypes/ne-wditypes-_wdi_roam_trigger) (UINT32) | 指定此漫游是关键漫游因为 AP 已设置其 BSS 转换请求操作框架中解除关联即将位。                                                                         |
