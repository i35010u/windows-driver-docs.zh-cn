...
ms.locfileid: "56525091"
---
# <a name="mb-ndis-status-notifications"></a>MB NDIS 状态通知


移动宽带 (MB) 微型端口驱动程序的此部分 NDIS 状态通知：

[**NDIS\_状态\_WWAN\_身份验证\_响应**](ndis-status-wwan-auth-response.md)

[**NDIS_STATUS_WWAN_BASE_STATIONS_INFO**](ndis-status-wwan-base-stations-info.md)

[**NDIS\_状态\_WWAN\_上下文\_状态**](ndis-status-wwan-context-state.md)
...
[**NDIS\_状态\_WWAN\_设备\_服务\_响应**](ndis-status-wwan-device-service-response.md)

[**NDIS\_状态\_WWAN\_设备\_服务\_会话**](ndis-status-wwan-device-service-session.md)

[**NDIS\_STATUS\_WWAN\_DEVICE\_SERVICE\_SESSION\_READ**](ndis-status-wwan-device-service-session-read.md)

[**NDIS\_状态\_WWAN\_设备\_服务\_会话\_编写\_完成**](ndis-status-wwan-device-service-session-write-complete.md)

[**NDIS\_状态\_WWAN\_设备\_服务\_订阅**](ndis-status-wwan-device-service-subscription.md)

[**NDIS\_状态\_WWAN\_设备\_服务\_支持\_命令**](ndis-status-wwan-device-service-supported-commands.md)

[**NDIS\_状态\_WWAN\_设备\_槽\_映射**](ndis-status-wwan-device-slot-mappings.md)
...
[**NDIS\_状态\_WWAN\_PREFERRED\_多\_提供程序**](ndis-status-wwan-preferred-multicarrier-providers.md)

[**NDIS\_STATUS\_WWAN\_PREFERRED\_PROVIDERS**](ndis-status-wwan-preferred-providers.md)

[**NDIS\_状态\_WWAN\_PRESHUTDOWN\_状态**](ndis-status-wwan-preshutdown-state.md)

[**NDIS\_状态\_WWAN\_已设置\_上下文**](ndis-status-wwan-provisioned-contexts.md)
...
[**NDIS\_状态\_WWAN\_设置\_主页\_提供程序\_完成**](ndis-status-wwan-set-home-provider-complete.md)

[**NDIS\_状态\_WWAN\_信号\_状态**](ndis-status-wwan-signal-state.md)
...
[**NDIS\_状态\_WWAN\_SMS\_删除**](ndis-status-wwan-sms-delete.md)
...
[**NDIS\_状态\_WWAN\_SYS\_CAP**](ndis-status-wwan-sys-caps.md)

[**NDIS_STATUS_WWAN_UICC_RESET_INFO**](ndis-status-wwan-uicc-reset-info.md)

[**NDIS\_状态\_WWAN\_USSD**](ndis-status-wwan-ussd.md)
