...
ms.date: 08/08/2017
keywords: -从 Windows Vista 开始 OID_NIC_SWITCH_CURRENT_CAPABILITIES 网络驱动程序
...
-   NDIS 将基础网络适配器的当前启用的 NIC 交换机硬件功能报告到 NDIS 的**NicSwitchCapabilities**成员中的过量协议驱动程序， [ **\_\_** ](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_bind_parameters)在绑定操作。

-   NDIS 报告基础网络适配器的当前启用的 NIC 交换机硬件功能，以覆盖 NDIS\_筛选器的**NicSwitchCapabilities**成员中的驱动程序， [ **\_附加\_参数**](https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_filter_attach_parameters)结构。
