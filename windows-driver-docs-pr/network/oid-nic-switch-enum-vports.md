...
驱动程序或应用程序发出 OID 请求之前，必须将格式化[ **NDIS\_NIC\_交换机\_VPORT\_信息\_数组**](https://msdn.microsoft.com/library/windows/hardware/hh451595)随请求一起传递的结构。 驱动程序或应用程序初始化时，必须遵循这些准则**NDIS\_NIC\_交换机\_VPORT\_信息\_数组**结构：
...
有关详细信息，请参阅[枚举网络适配器上的虚拟端口](https://msdn.microsoft.com/library/windows/hardware/hh406710)。
...
****
[**NDIS\_NIC\_交换机\_VPORT\_信息**](https://msdn.microsoft.com/library/windows/hardware/hh451594)

[**NDIS\_NIC\_交换机\_VPORT\_信息\_数组**](https://msdn.microsoft.com/library/windows/hardware/hh451595)
