...
Win32 命名空间中的设备的单元号不必是用来构成的内核设备名称相同。 它应该是第一个可用的单元数。 使用[ **SmartcardCreateLink (WDM)** ](https://docs.microsoft.com/previous-versions/ff548935(v=vs.85))自动生成符号链接的名称。
